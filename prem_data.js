...
var PREM_DATA = {
  ...
  currentUnit: { n:23, topic:'Physics: Static Electricity &amp; Electric Charges', status:'Lessons + test ready &middot; third unit of the U21-U30 gap-closure cycle, and the first static-electricity content anywhere in the program. Lesson 1 opens with a &quot;Quick Fix from Unit 22&quot; recap (symptom-to-nutrient reverse-lookup drill plus a null-result fair-test teaching note), recalls U6&#39;s electrons, then covers protons/electrons, neutral vs charged objects, and charging by friction (electron transfer). Lesson 2 covers electrostatic induction/polarisation (attracting a NEUTRAL object without touching it), directly targeting Competition C2&#39;s Q17b gap, plus everyday effects (static cling, hair standing up, doorknob shocks) and lightning. Test: 20 questions, 4A/6B/10C, PASS_BAR 16, with 3 embedded verification questions re-testing U22&#39;s two open gaps (Q7/Q8 symptom-to-nutrient, Q14 null-result fair test) using fresh scenarios. Verified position-balanced 5/5/5/5, length-margin clean, zero real overlap against the lesson/test corpus, and audited bare-term-only for Section A per the new no-definitional-hints rule.' },

  lastUnit: {
    n:22, score:15, outOf:20, pct:75, delta:-25, prevScore:100, passed:false,
    patternLabel: 'Unit 22 result - Biology: Nutrition, Vitamins &amp; a Balanced Diet (15/20, 75% - FAIL, third program fail)',
    patternInsight: '<strong>15/20 questions (75%)</strong> - FAIL, below the 16/20 pass bar. Section A (basic recall) = <strong>3/4 (75%)</strong>. Section B (applying, &#9733;) = <strong>4/6 (67%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>8/10 (80%)</strong>.',
    analysisLabel: 'Competition C2&#39;s Q18 (Vitamin C) NOT yet confirmed closed &middot; a precise symptom-to-nutrient reverse-reasoning gap found, plus a new null-result fair-test gap',
    analysisInsight: 'Headline finding: given physical SYMPTOMS (bleeding gums/exhaustion, low blood oxygen), Prem twice defaulted to guessing Calcium instead of correctly identifying Vitamin C or Iron (Q7, Q10) - even though diet-to-deficiency FORWARD reasoning (given what someone eats, predict a deficiency) stayed solid across two questions (Q9, Q19). This means Competition Q18 is NOT yet confirmed closed. A second, genuinely new gap also surfaced: interpreting a fair test that shows NO difference as still a valid, informative result (Q17), plus a related fair-test-design miss (Q12). One isolated Section A recall slip (Q2, vitamins/minerals vs fats). A post-hoc integrity fix was also needed: Q2-Q4 had hint-leaking &quot;term + defining clause&quot; options (fixed to bare terms for all future takers) - Q3/Q4 were already answered correctly either way, so the 15/20 score is unaffected, but those two facts should be read with reduced confidence. Both open items are directly targeted by Unit 23&#39;s &quot;Quick Fix from Unit 22&quot; screen and 3 embedded verification questions.',
    qSummary: '<strong>15 / 20 (75%) - FAIL, below the 16/20 pass bar.</strong> Third program fail. Headline: symptom-to-nutrient reverse reasoning defaults to Calcium (Q7, Q10) even though forward diet-to-deficiency reasoning is solid; a new null-result fair-test interpretation gap (Q17, Q12); one isolated recall slip (Q2). Competition Q18 (Vitamin C) NOT yet confirmed closed.',
    qBreakdown: []
  },

  skills: [
    { name: 'Biology',                  c: 89, t: 85, ev:'U4 Microorganisms 15/15 PERFECT + U8 Photosynthesis 20/20 PERFECT + U11 Human Body Systems 20/20 PERFECT + U14 Cells 19/20 (95%) + U17 Ecosystems 17/20 (85%) - closed G4 Q40, the U1 Q13 gas-exchange thread, and Competition Q24/Q7/Q14/Q32 (Q31 substantially closed) + U20 Gap-Closure Checkpoint 16/20 (80%) - upgraded germination-light to a confirmed recurring gap + Milestone Test 2 36/40 (95%) - three of the four misses were Biology (Q4 cell-wall-vs-membrane, Q9 germination soil-vs-warmth, Q10 anther-vs-ovary), all isolated single-fact recall slips with no shared mechanism, while both dedicated germination/observation-inference re-test questions (Q24, Q32) were answered correctly + U22 Nutrition, Vitamins &amp; a Balanced Diet 15/20 (75%, FAIL) - the third program fail; a precise symptom-to-nutrient reverse-reasoning gap (Calcium default-guess signature) found, Competition Q18 (Vitamin C) NOT yet confirmed closed, directly targeted by U23&#39;s Quick Fix' },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'Third unit of the U21-U30 cycle', c:'torange' },
        { t:'Targets Competition C2 Q17b gap', c:'tblue' },
