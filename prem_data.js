...
var PREM_DATA = {
  ...
  currentUnit: { n:43, topic:'Earth &amp; Space: The Solar System (school-aligned)', status:'&#9989; Ready to start &mdash; built 28-30 Aug 2026. First unit of a NEW 7-unit school-aligned block, matching Chapter 1 of Prem&#39;s Y5 i-Science course book &mdash; the U41-U50 ASMOPSS-track rotation is postponed after only 2 of 10 units per Lui&#39;s 28 Aug 2026 decision. Lesson 1 opens with a spiral-maintenance warm-up from Chemistry U9/U12 (material origins), briefly recaps Unit 7&#39;s rotation/revolution, then teaches the Sun (a star, hot gases, energy source) and Earth (three layers, life-supporting conditions) as genuinely new content. Lesson 2 briefly recaps Unit 7&#39;s Moon phases, then covers new surface-feature content, the 8-planet order and two planet families (rocky vs gas giant), and man-made satellites &mdash; never taught before in this program. Includes Trap-Recognition Drill #7. Test: 20 questions, tier-tagged throughout, reweighted to 2 Basic/6 Intermediate/12 Applied (10/30/60%) &mdash; up from the program&#39;s standard 4/6/10 split &mdash; per Lui&#39;s 30 Aug 2026 instruction to weight all 7 school-aligned units (U43-U49) more heavily toward Intermediate &amp; Applied ASMOPSS tiers. Section C sourced as genuine cross-topic synthesis from U6/U8 (energy chain, photosynthesis) and U36 (fair-test design).' },

  lastUnit: {
    n:42, score:20, outOf:20, pct:100, passBar:16, delta:25, prevScore:75, passed:true,
    patternLabel: 'Unit 42 result - Physics: Circuits Deep Dive: Series vs Parallel (20/20, 100% PERFECT)',
    patternInsight: '<strong>20/20 (100%)</strong> - PASS, PERFECT, the program&#39;s SIXTH perfect score (after U8, U21, U27, U33, U36). Section A = <strong>4/4</strong>. Section B = <strong>6/6</strong>. Section C = <strong>10/10</strong>. Tier breakdown matches section breakdown exactly: Basic 4/4, Intermediate 6/6, Applied 10/10. Zero misses anywhere.',
    analysisLabel: 'Every confirming rep and genuine cross-topic synthesis question held clean &middot; the deliberately-contrasting switch-placement pair both correct &middot; U41&#39;s acid/base findings not yet re-tested (placed as ungraded screens)',
    analysisInsight: '<strong>Every dedicated confirming rep and cross-topic synthesis question held clean.</strong> The energy-chain (Q11, U6) and conductor/insulator (Q12, U6/U34) cross-topic questions both correct. The deliberately-contrasting switch-placement pair (Q13 before-the-split affects ALL branches; Q14 after-the-split-on-one-branch affects only ONE) both correct - the first real test of whether this distinction transfers on brand-new content with no prior teaching to lean on, and it held cleanly. The fair-test-design cross-topic question (Q17, U36) and the Applied-tier trap-recognition item (Q16, &quot;one bulb dark always means the whole circuit is broken&quot; - false) both correct. Trap-Recognition Drill #6 also held. <strong>Note:</strong> U41&#39;s two carried-forward findings (acid/base identity, chemical-irreversibility overgeneralization) were placed as UNGRADED Quick Fix screens in Lesson 1 per the standing convention, so their pass/fail isn&#39;t captured in this results file.',
    qSummary: '<strong>20 / 20 (100%) - PASS, PERFECT.</strong> Section A 4/4, Section B 6/6, Section C 10/10. Sixth perfect score of the program. Every deliberately-designed synthesis and contrast question held, including the switch-placement contrast pair. Per Lui&#39;s 28 Aug 2026 decision, the U41-U50 rotation is now postponed after only 2 units - the next 7 units align with Prem&#39;s school Science class (Y5 i-Science course book), starting with Unit 43: The Solar System.',
    qBreakdown: []
  },
  ...
  radarCurrent:  [89, 91, 95, 91, 95, 95],
