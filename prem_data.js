...
var PREM_DATA = {
  ...
  currentUnit: { n:26, topic:'Physics: Speed, Distance &amp; Time', status:'Lessons + test ready &middot; sixth unit of the U21-U30 gap-closure cycle, and a new foundational Physics topic touching the plain-language idea behind Competition C2&#39;s Q28 (average speed) without needing the underlying algebra. Also carries two ESCALATED Quick Fixes for U25&#39;s two significant unresolved gaps: the stamen/pistil (anther-vs-ovary) confusion, confirmed TWICE within U25&#39;s single test (Q3 bare recall, Q18 descriptive scenario), and the Iron/oxygen fact, now failed on a THIRD consecutive attempt across three different framings (diet-symptom in U22, breathless-athlete in U23, blood-test-result in U25) - both flagged as needing a genuinely different teaching device, not another quiz-style re-test, following the precedent set by U24&#39;s successful resolution of the null-result fair-test gap via a coin-flip analogy. Lesson 1 `SpeedDistanceTime_Lesson_WhatIsSpeed.html` (green, 8 screens: pocket map, an ESCALATED Iron Quick Fix using a brand-new &quot;delivery-truck&quot; analogy (iron atoms as trucks whose one job is carrying oxygen - a concrete picture rather than another verbal restatement) with 2 quick-checks, an ESCALATED stamen/pistil Quick Fix using an interactive click-to-sort mini-game (5 flower parts sorted into STAMEN/PISTIL bins with immediate feedback, replacing passive diagram-viewing with active retrieval practice), why, the Speed = Distance &divide; Time formula with a worked example, comparing speeds with a cheetah-vs-greyhound worked example, decision tree, 5Q practice). Lesson 2 `SpeedDistanceTime_Lesson_TheDSTTriangle.html` (blue, 8 screens: pocket map, Quick Recall from Lesson 1, why, the full Distance-Speed-Time cover-up triangle with an SVG diagram and all three rearranged formulas, worked examples for each rearrangement including a unit-conversion caution, a NEW &quot;Average Speed&quot; screen explaining - in plain language, without algebra - why equal-distance segments at different speeds do NOT average to the simple midpoint (the slower speed &quot;counts for more&quot; since more time is spent at it), decision tree, 5Q practice). Test `Tests\\Unit_26_Test_SpeedDistanceTime.html` (20Q, 4A/6B/10C, PASS_BAR 16) covers the speed formula and all three rearrangements, comparing speeds, the average-speed concept, and fair-test reasoning applied to speed comparisons, plus one re-test question each for Iron (4th framing: a supplement-bottle-label scenario) and stamen/pistil (3rd framing: a mislabelled-diagram correction). Position distribution exact 5/5/5/5. An initial length-margin pass found 5 questions with a uniquely-longest correct answer (up to 90% margin) - rebalanced by lengthening distractors down to a max ~22% margin, none over. A Jaccard overlap check against both new lessons caught two near-duplicate calculation questions (a car-speed and a cyclist-distance template that only changed the numbers from lesson practice questions) - both reworded with fresh vehicles/contexts (motorbike, jogger). The new DST-triangle SVG diagram was rasterized and visually verified with no bugs found. Scoring engine verified via a Node harness (20 valid questions, correct 4/6/10 section split, perfect run scores 20/20, all-wrong run scores 0/20).' },

  lastUnit: {
    n:25, score:14, outOf:20, pct:70, delta:-25, prevScore:95, passed:false,
    patternLabel: 'Unit 25 result - Biology: Seeds, Plant Reproduction &amp; Dispersal (14/20, 70% - FAIL, ties Unit 13 as the lowest score of the program)',
    patternInsight: '<strong>14/20 questions (70%)</strong> - FAIL, below the 16/20 bar. Section A (basic recall) = <strong>3/4 (75%)</strong>. Section B (applying, &#9733;) = <strong>4/6 (67%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>7/10 (70%)</strong>.',
    analysisLabel: 'Stamen/pistil (anther-vs-ovary) gap CONFIRMED across 2 question formats in a single test &middot; Iron/oxygen fact failed a THIRD consecutive attempt &middot; germination shows a bare-recall-vs-application split &middot; two isolated new-content misses',
    analysisInsight: 'Headline finding: the stamen/pistil confusion is now CONFIRMED, not a one-off slip - Q3 (bare &quot;which part belongs to the pistil team&quot; recall) and Q18 (a descriptive scenario sorting a pollen-covered knob vs a sticky-tipped stalk) both tested the identical male/female sorting skill in different formats, and both were missed (Q3: chose Filament instead of Ovary; Q18: reversed the male/female labels entirely). Separately, Q9 (a blood-test iron scenario) was missed by choosing &quot;fighting off infections&quot; instead of &quot;carrying oxygen&quot; - notably NOT the old Calcium-default guess, meaning the core iron&rarr;oxygen fact itself, not just a guessing habit, has now failed on THREE consecutive attempts (U22 diet-symptom, U23 breathless-athlete, U25 blood-test). A third pattern: Q1 (bare germination 3-things recall) was answered correctly, but Q13 (an applied critique of &quot;seeds never need soil&quot;) was missed - the same bare-recall-vs-application split first seen in the U13&rarr;U14&rarr;U15 light-source arc, meaning Milestone 2&#39;s Q9 germination gap is only PARTIALLY closed. Two lighter, likely isolated misses: Q10 (dispersal feature identification, chose feathery-tuft instead of hooked-spikes) and Q15 (pollination-vs-germination vocabulary mix-up in an anther-removal scenario).',
    qSummary: '<strong>14 / 20 (70%) - FAIL, below the 16/20 pass bar, ties Unit 13 as the lowest score of the program.</strong> Two significant open items: the stamen/pistil (anther-vs-ovary) confusion is now CONFIRMED across two different question formats in this one test, and the Iron/oxygen fact has now failed a THIRD consecutive attempt across three different framings (diet-symptom, breathless-athlete, blood-test) - both need a genuinely different teaching approach next, not another quiz-style re-test. A narrower item: germination shows a bare-recall-vs-application split (Q1 correct, Q13 wrong). Two lighter, likely isolated misses round out the result (Q10 dispersal feature, Q15 pollination vocabulary).',
    qBreakdown: []
  },

  skills: [
    { name: 'Biology',                  c: 87, t: 85, ev:'U4 Microorganisms 15/15 PERFECT + U8 Photosynthesis 20/20 PERFECT + U11 Human Body Systems 20/20 PERFECT + U14 Cells 19/20 (95%) + U17 Ecosystems 17/20 (85%) - closed G4 Q40, the U1 Q13 gas-exchange thread, and Competition Q24/Q7/Q14/Q32 (Q31 substantially closed) + U20 Gap-Closure Checkpoint 16/20 (80%) - upgraded germination-light to a confirmed recurring gap + Milestone Test 2 36/40 (95%) - three of the four misses were Biology (Q4 cell-wall-vs-membrane, Q9 germination soil-vs-warmth, Q10 anther-vs-ovary), all isolated single-fact recall slips with no shared mechanism, while both dedicated germination/observation-inference re-test questions (Q24, Q32) were answered correctly + U22 Nutrition, Vitamins &amp; a Balanced Diet 15/20 (75%, FAIL) - the third program fail; a precise symptom-to-nutrient reverse-reasoning gap (Calcium default-guess signature) found, Competition Q18 (Vitamin C) NOT yet confirmed closed, directly targeted by U23&#39;s Quick Fix + U23&#39;s two embedded Biology re-test questions (within the Physics test): the Vitamin C/scurvy direction closed cleanly (Q7 correct) - Competition Q18 is now CONFIRMED CLOSED - but the Iron/oxygen direction persisted (Q8, same Calcium-default guess) + U25 Seeds, Plant Reproduction &amp; Dispersal 14/20 (70%, FAIL) - ties Unit 13 as the lowest score of the program; the stamen/pistil (anther-vs-ovary) confusion is now CONFIRMED across two question formats in one test (Q3, Q18), the Iron/oxygen fact failed a THIRD consecutive attempt with a NEW error signature (no longer defaulting to Calcium - the core fact itself is unretained), and germination shows a bare-recall-vs-application split (Q1 correct, Q13 wrong) - all three escalated to genuinely different teaching approaches in U26' },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'Sixth unit of the U21-U30 cycle', c:'torange' },
        { t:'Escalated Iron + stamen/pistil Quick Fixes', c:'tblue' },
