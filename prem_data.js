...
var PREM_DATA = {
  ...
  currentUnit: { n:39, topic:'Physics: Gravity, Forces &amp; Working-Memory Stress Test', status:'&#9989; Ready to take &mdash; built 14 Aug 2026. Third unit of the post-ASMOPSS rotation (&sect;50) &mdash; no major new content, a deliberate spaced re-test of gravity/air-resistance (the real exam&#39;s Q12 regression) and multi-step force-combination/magnet-chain skills, including the exact &quot;flip&quot; operation that broke the real exam&#39;s Q33. Embeds Trap-Recognition Drill #2 inside force/gravity/magnet contexts. Tier-tagged, same-fact-pair design rule applied throughout.' },

  lastUnit: {
    n:38, score:19, outOf:20, pct:95, delta:10, prevScore:17, passed:true,
    patternLabel: 'Unit 38 result - Plant Reproduction Outcomes: Fruit vs Seed (19/20, 95% PASS)',
    patternInsight: '<strong>19/20 (95%)</strong> - PASS, best result of the post-ASMOPSS rotation so far, and the first test built entirely under the new same-fact-pair design rule. Section A = <strong>4/4 (100%)</strong>. Section B = <strong>6/6 (100%)</strong>. Section C = <strong>9/10 (90%)</strong>. Tier breakdown: Basic 4/4, Intermediate 6/6, Applied 9/10.',
    analysisLabel: 'First Spaced-Retention Checkpoint 3/3 clean &middot; Trap-Recognition Drill #3 4/4 &middot; one isolated multi-step-chaining slip',
    analysisInsight: 'One miss: Q13. <strong>Spaced-retention finding:</strong> all three spaced-retention items (Q7 anther/stigma, Q8 duckweed-style roots, Q17 anther/ovary team roles &mdash; all facts confirmed closed a month or more ago) came back correct &mdash; the program&#39;s first live test of the spaced-retention rule, and a clean pass. <strong>Trap-recognition finding:</strong> Trap-Recognition Drill #3 went 4/4 (Q11, Q12, Q16, Q19), the best trap-recognition result yet, suggesting the skill is transferring cleanly. <strong>Content finding:</strong> the one miss, Q13, asked Prem to chain the full pathway (pollination &rarr; fertilization &rarr; seed &rarr; fruit) into one multi-step explanation; he attributed the fruit-forming role to the anther instead of the ovary, despite getting both component facts right in isolation elsewhere in the same test (Q1 ovary&rarr;fruit correct, Q17 anther/ovary team roles correct). This matches a recurring shape seen before (U29 force-grouping, U34 magnet-chain derivation): individual facts hold, but chaining several into one multi-step narrative is where errors surface. Not a fresh content gap &mdash; recommended fix is folding one light &quot;explain the full chain&quot; question into a future confirming rep, not a dedicated lesson.',
    qSummary: '<strong>19 / 20 (95%) - PASS.</strong> Section A 4/4, Section B 6/6, Section C 9/10. Headline: first Spaced-Retention Checkpoint went 3/3 clean, Trap-Recognition Drill #3 went 4/4, and the one miss (Q13) was a multi-step-chaining slip, not a content gap. Confirmed next assessment: Unit Test (U39).',
    qBreakdown: []
  },
