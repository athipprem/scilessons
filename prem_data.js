...
var PREM_DATA = {
  ...
  currentUnit: { n:25, topic:'Biology: Seeds, Plant Reproduction &amp; Dispersal', status:'Lessons + test ready &middot; fifth unit of the U21-U30 gap-closure cycle, targeting Milestone Test 2&#39;s Q9 (germination soil-vs-warmth confusion) and Q10 (anther-vs-ovary mix-up), plus carrying forward the still-open Iron symptom-to-nutrient gap from U22/U23. Lesson 1 `Seeds_Lesson_GerminationToSeedling.html` opens with an escalated Iron re-test (two Quick Checks split into symptom-recognition vs causal-mechanism, since two prior attempts both defaulted to Calcium), then goes past a bare recap of U17&#39;s germination rule (water/warmth/air, not soil/light) into genuine causal depth - WHY warmth matters (temperature-sensitive helper substances) and WHY soil isn&#39;t needed yet (the seed&#39;s own stored food) - plus new content on the seed-to-seedling stage transition, where soil and light finally do become essential. Lesson 2 `Seeds_Lesson_ReproductionAndDispersal.html` recaps the stamen/pistil male-female sort with a new labelled flower-anatomy SVG diagram (directly targeting the anther-vs-ovary confusion), the pollination-to-fertilization-to-seed cycle, and new content on seed dispersal (wind, animal, water) with an SVG diagram. Test `Tests\\Unit_25_Test_SeedsPlantReproduction.html` (20Q, 4A/6B/10C, PASS_BAR 16) verified position-balanced 5/5/5/5, length-margin clean after one rebalancing pass (7 questions initially had a uniquely-longest correct answer with margins up to 101%, brought down to a max ~21% margin across 6 questions by lengthening distractors), and a Jaccard overlap sweep against both new lessons caught and fixed three near-duplicate questions (a definitional pollination question, a male-team stamen question, and a dispersal-by-water question all reworded with fresh framings/examples). Both new SVG diagrams (flower anatomy cross-section, seed dispersal methods) were rasterized and visually verified with no bugs found.' },

  lastUnit: {
    n:24, score:19, outOf:20, pct:95, delta:15, prevScore:80, passed:true,
    patternLabel: 'Unit 24 result - Chemistry: Density, Buoyancy &amp; Thermal Expansion (19/20, 95% - PASS, best result since U21&#39;s perfect score)',
    patternInsight: '<strong>19/20 questions (95%)</strong> - PASS, comfortably above the 16/20 bar. Section A (basic recall) = <strong>4/4 (100%)</strong>. Section B (applying, &#9733;) = <strong>6/6 (100%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>9/10 (90%)</strong>.',
    analysisLabel: 'Competition C2&#39;s Q27 (density calculation) and Q30 (buoyancy vs temperature) both CONFIRMED CLOSED &middot; null-result fair-test gap RESOLVED on the THIRD remediation attempt via a coin-flip escalation &middot; one light, likely framing-specific Q16 slip',
    analysisInsight: 'Headline finding: Competition C2&#39;s Q27 (density calculation) is CONFIRMED CLOSED - the gold-ring identification question (Q19) and every other mass&divide;volume calculation question were answered correctly. Q30 (buoyancy vs temperature) is also CONFIRMED CLOSED - Q9, Q14, Q18, and Q20 (the hollow-ship/temperature/buoyancy reasoning cluster) were all answered correctly. Most significantly, the null-result fair-test gap that had failed to close on TWO consecutive prior attempts (U22&#39;s Q17, U23&#39;s Q14) was finally RESOLVED this unit - Q12 (the saucepan-lid colour experiment) was answered correctly, validating the decision to escalate to a genuinely different teaching approach (a coin-flip fairness analogy) rather than repeating the same style of remediation a third time. The one miss, Q16 (a heated sealed balloon, &quot;heating adds mass&quot; distractor chosen), reads as a framing-specific slip rather than a fresh gap - the identical same-mass-bigger-volume-lower-density logic was tested in two other questions (Q13, Q20), both answered correctly.',
    qSummary: '<strong>19 / 20 (95%) - PASS, comfortably above the 16/20 pass bar, the best result since U21&#39;s perfect score.</strong> Headline: Competition Q27 (density calculation) and Q30 (buoyancy vs temperature) both CONFIRMED CLOSED. The null-result fair-test gap - stubborn across two prior remediation attempts - is finally RESOLVED after escalating to a coin-flip analogy. One light miss (Q16, heated balloon, &quot;heating adds mass&quot;) reads as a framing-specific slip, not a new gap, since the same core logic was answered correctly twice elsewhere in the same test.',
    qBreakdown: []
  },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'Fifth unit of the U21-U30 cycle', c:'torange' },
        { t:'Targets M2 Q9/Q10 + Iron re-test', c:'tblue' },
