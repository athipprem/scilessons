...
var PREM_DATA = {
  ...
  currentUnit: { n:45, topic:'Biology: Reproduction in Animals (school-aligned)', status:'&#9989; Ready to start &mdash; built 3 Sep 2026. Third unit of the 7-unit school-aligned block, matching Chapter 3 of Prem&#39;s Y5 i-Science course book. Lesson 1 opens with a fresh-scene confirming rep for Unit 44&#39;s real-taken miss pattern (confusing total cell quantity/body size with active division RATE right now), then a spiral-maintenance warm-up from Physics U21 (gravity/free fall/air resistance, stale since June and untouched by any milestone), recaps Unit 31&#39;s five vertebrate groups, then introduces genuinely new content: sexual reproduction and internal vs external fertilisation. Lesson 2 covers the three life-cycle types (no metamorphosis, incomplete metamorphosis, complete metamorphosis), including Trap-Recognition Drill #9 (the &quot;ALL animals go through metamorphosis&quot; absolute-claim trap). Test: 20 questions, tier-tagged (2 Basic/6 Intermediate/12 Applied, per the standing U43-U49 reweighting rule), Section C sourced as genuine cross-topic synthesis from U4/U11/U25/U36/U44. A lesson-vs-test overlap sweep caught and rewrote 7 near-duplicate questions before shipping (see feedback-no-near-duplicate-confirming-reps in project memory).' },

  lastUnit: {
    n:44, score:18, outOf:20, pct:90, passBar:16, delta:-5, prevScore:95, passed:true,
    patternLabel: 'Unit 44 result - Biology: Cells &amp; Cell Division, school-aligned (18/20, 90% PASS)',
    patternInsight: '<strong>18/20 (90%)</strong> - PASS. Section A = <strong>2/2</strong>. Section B = <strong>6/6</strong>. Section C = <strong>10/12</strong>. Tier breakdown matches section breakdown exactly: Basic 2/2, Intermediate 6/6, Applied 10/12 (83%). Two misses, both Applied tier.',
    analysisLabel: 'Both misses (Q12, Q17) trace to ONE shared root cause &mdash; confusing total cell quantity/body size with active division RATE/purpose right now',
    analysisInsight: '<strong>Both Applied-tier misses point the same way, not two unrelated gaps.</strong> Q12 (ongoing red-blood-cell replacement) was called &quot;growth&quot; instead of &quot;repair&quot;; Q17 (comparing a 5-year-old to a 40-year-old) picked the adult as dividing faster for growth, reasoning that a bigger body &quot;needs more cells to function&quot; rather than tracking current growth rate. Both misses trace to the same underlying confusion: mistaking static cell quantity/body size for the dynamic purpose or rate of division happening right now. Section A and B held perfectly clean, matching U43&#39;s strong Basic/Intermediate pattern.',
    qSummary: '<strong>18 / 20 (90%) - PASS.</strong> Section A 2/2, Section B 6/6, Section C 10/12. Second real-taken result of the 7-unit school-aligned block. Both misses share one coherent root cause (cell quantity/body size vs. active division rate), enabling a single targeted remediation fold-in rather than two. Confirmed next assessment: Unit 45, Biology: Reproduction in Animals (school-aligned), matching Chapter 3 of the course book.',
    qBreakdown: []
  },

  skills: [
    { name: 'Biology',                  c: 90, t: 85, ev:'U4 Microorganisms 15/15 PERFECT + U8 Photosynthesis 20/20 PERFECT + U11 Human Body Systems 20/20 PERFECT + U14 Cells 19/20 (95%) + U17 Ecosystems 17/20 (85%) - closed G4 Q40, the U1 Q13 gas-exchange thread, and Competition Q24/Q7/Q14/Q32 (Q31 substantially closed) + U20 Gap-Closure Checkpoint 16/20 (80%) - upgraded germination-light to a confirmed recurring gap + Milestone Test 2 36/40 (95%) - three of the four misses were Biology, all isolated single-fact recall slips + U22 Nutrition, Vitamins &amp; a Balanced Diet 15/20 (75%, FAIL) - the third program fail; a precise symptom-to-nutrient reverse-reasoning gap found + U25 Seeds, Plant Reproduction &amp; Dispersal 14/20 (70%, FAIL) - the stamen/pistil confusion CONFIRMED across two formats, the Iron/oxygen fact failed a THIRD consecutive attempt + U26&#39;s two embedded Biology re-test questions (within the Physics test): BOTH gaps CLOSED on the escalated first attempt - Iron (Q9, a delivery-truck-analogy Quick Fix, 4th framing) and stamen/pistil (Q10, a sorting-mini-game Quick Fix, 3rd framing) both answered correctly, confirming the escalation-to-a-different-teaching-device strategy worked for both of these long-running gaps + Milestone Test 3 34/40 (90%): the anther-vs-ovary confusion REGRESSED (Q10) after being closed by U30, germination-light reactivated at bare recall (Q9) despite a correct critique-level answer later in the same test, but the anther-vs-stigma applied check (Q32) held - directly targeted by U31&#39;s Quick Fix and new Classification/Digestion content + U31 Classification &amp; Digestion 16/20 (80%, PASS): the anther-vs-ovary Quick Fix FAILED both dedicated confirming reps identically (Q8, Q16) - a THIRD consecutive miss on this fact across M2&#8594;M3&#8594;U31, now escalated to a genuinely different teaching device (3-way JOB-sort mini-game) in U32; germination-light fully RESOLVED (Q4, Q17); two new gaps found (Q15 analogy-transfer, Q19 fair-test variable confusion) - independently reinforced by an ASMOPSS 2024 G4 Set B retake (1 Aug 2026) missing the identical anther/stigma diagram swap a month apart (Q32) + U44 Cells &amp; Cell Division (school-aligned) 18/20 (90%, PASS): the program&#39;s first Biology unit built under the 2/6/12 tier reweighting; Section A and B both perfect, both misses (Q12, Q17) traced to ONE shared confusion - mistaking total cell quantity/body size for the active division rate/purpose happening right now - rather than two unrelated gaps, enabling a single targeted fresh-scene confirming rep in U45 rather than two' },
  ...
  radarCurrent:  [90, 91, 95, 92, 95, 95],
