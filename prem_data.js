...
var PREM_DATA = {
  ...
  currentUnit: { n:36, topic:'Scientific Investigation Skills: Multi-Group Fair Tests, Data Trends &amp; Conductors', status:'Test ready &middot; a bonus unit added 7 Aug 2026, one day before ASMOPSS 2026 (9 Aug), built directly from Mock Test 1&#39;s hard-tier (Section C) analysis. Cross-referencing the real 2024/2025 ASMOPSS G4 Set B papers&#39; own 5-mark tier shows it draws almost entirely from applied scientific-investigation reasoning (fair-test/control-group critique, data-trend/anomaly reading, reverse-factor inference) regardless of subject label &mdash; exactly where Mock Test 1 cracked for the first time (Section C dropped to 6/8). Lesson 1 `SciSkills_Lesson_FairTestsAndVariables.html` teaches the &quot;clue table&quot; method for multi-group (3+) fair tests, directly targeting Mock Test 1&#39;s Q36 failure mode (a 3-leaf multi-condition set-up). Lesson 2 `SciSkills_Lesson_DataTrendsAndConductors.html` teaches trend-vs-anomaly data reading and two-clue reverse-factor inference (targeting Q38&#39;s cactus-factor miss), plus carries the ESCALATED conductor/insulator Quick Fix &mdash; a 2-bin sort-game (the 3rd escalation device used in this program) directly built around the exact objects Prem has now missed three times running (a steel spoon, a brass button, a steel paperclip &mdash; always a metal object mistaken for the insulator). Test `Tests\\Unit_36_Test_ScientificInvestigationSkills.html` (20Q, 4A/6B/10C, PASS_BAR 16, indigo theme) gives 3 dedicated conductor/insulator confirming reps (Q2, Q8, Q15), 2 fresh multi-group fair-test scenarios (Q11/Q12 cress trays, Q19 milk glasses; Q5/Q6 soup bowls in Section B), 2 two-clue reverse-factor questions (Q9 fish habitat, Q14 bird habitat), 2 trend/anomaly questions (Q7, Q13, Q16, Q18), and a fair-test-critique question (Q17). Built and verified: position-balanced exact 5/5/5/5 matching the project&#39;s rotation formula, a length-margin pass fixed 16 initially-flagged questions, a Jaccard overlap check caught and fixed 3 near-duplicates against the corpus (Q2 echoed both Mock Test 1&#39;s and U35&#39;s conductor/insulator stems, Q17 echoed U35&#39;s sunlight/tomato fair-test scenario, Q19 originally used a 3-magnet-tower framing that echoed U35&#39;s magnet-block question so closely it was replaced entirely with a milk-glasses multi-group scenario), and zero hint-leak flags. No SVG diagrams used this unit &mdash; the clue-table method uses HTML tables instead. Scoring engine verified via a Node harness (perfect run 20/20, correct 4/6/10 section split; all-wrong run 0/20). Full 10-year-old role-play verification pass completed end-to-end.' },

  lastUnit: {
    n:'MK1', score:31, outOf:40, pct:78, delta:0, prevScore:78, passed:false,
    patternLabel: 'Mock Test 1 result - Full Syllabus Practice (31/40, 77.5/100 marks, 78% - FAIL by 2.5 marks)',
    patternInsight: '<strong>31/40 (77.5/100 marks, 78%)</strong> - FAIL by just 2.5 marks, but Prem&#39;s best-ever ASMOPSS-format score. Section A = <strong>12/16 (75%)</strong>. Section B = <strong>13/16 (81%)</strong>. Section C = <strong>6/8 (75%)</strong>.',
    analysisLabel: 'Magnet-vs-material + 3-magnet chain BOTH CONFIRMED CLOSED &middot; conductor/insulator now an urgent 3-instance recurring gap &middot; new cross-topic &quot;wrong direction&quot; reading pattern',
    analysisInsight: 'BOTH of U35&#39;s open watch-items are now CONFIRMED CLOSED: magnet-vs-magnetic-material held across all three difficulty tiers including the fragile reverse-inference format that broke twice before (Q6, Q23, Q34), and the 3-magnet chain (Q33) and dependent/controlled-variable vocabulary (Q3, Q20) are both solid. But conductor/insulator (Q10) is now a CONFIRMED 3-INSTANCE RECURRING GAP (U34 -&gt; U35 -&gt; Mock Test 1), every miss picking a metal object (steel spoon, brass button, steel paperclip) instead of the real insulator - a specific misconception, not random error, now the program&#39;s top priority. A new cross-topic &quot;wrong direction&quot; reading pattern also surfaced across Q19/Q21/Q36 (data-trend, shadow-distance, and a multi-condition fair test all read backwards) - an exam-strategy concern distinct from a content gap. Two isolated misses (Q12, Q15). Unit 36, a dedicated Scientific Investigation Skills unit, directly targets the conductor/insulator escalation and the multi-condition fair-test reading pattern.',
    qSummary: '<strong>31 / 40 (77.5/100 marks, 78%) - FAIL by 2.5 marks, best-ever ASMOPSS-format score.</strong> Section A 12/16, Section B 13/16, Section C 6/8. Headline: magnet-vs-material and the 3-magnet chain both CONFIRMED CLOSED; conductor/insulator now an urgent 3-instance recurring gap (always picks a metal object); a new cross-topic wrong-direction reading pattern. Unit 36 (Scientific Investigation Skills) is next.',
    qBreakdown: []
  },
