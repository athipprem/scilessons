...
var PREM_DATA = {
  ...
  currentUnit: { n:34, topic:'Physics: Electricity, Magnetism &amp; Forces Recap', status:'Test ready &middot; two lessons (Circuits, Charges &amp; Magnetism Recap; Magnet Chains &amp; Combining Forces) + a 20Q test (4A/6B/10C, pass bar 16/20). Fourth of the final 5 units before ASMOPSS 2026 (9 Aug). Lesson 1 `ElecMagForces_Lesson_CircuitsChargesAndMagnetism.html` (green, 9 screens) recaps circuits (Unit 6), conductors/insulators, and static charges/induction (Unit 23), then introduces brand-new content: the magnet-vs-magnetic-material distinction - being attracted to a magnet does NOT make an object a magnet itself; only an object that can pull OTHER magnetic objects, unaided, is a true magnet - a fact never explicitly taught despite Unit 3&#39;s strong general magnetism foundation. Lesson 2 `ElecMagForces_Lesson_MagnetChainsAndCombiningForces.html` (blue, 8 screens) teaches a harder 3-magnet chain-reading method (check ONE join at a time, step-by-step worked derivation) directly targeting the ASMOPSS 2024 retake&#39;s magnet-pole diagram-reading regression on multi-magnet chains, then recaps forces and combining forces (same-direction adds, opposite subtracts, sort into direction-groups first for 3+ forces). Both lessons include a decision tree and 5Q practice. Test `Tests\\Unit_34_Test_ElectricityMagnetismAndForces.html` (20Q, 4A/6B/10C, PASS_BAR 16) covers circuits/conductors/static-charge recall, two dedicated magnet-vs-magnetic-material questions (Q6, Q13), two dedicated 3-magnet-chain questions (Q11, Q12), and combining-forces reasoning - built with fresh scenarios distinct from both lessons&#39; own practice questions. Built and verified: position-balanced exact 5/5/5/5 (fixed a severe initial 2/9/9/0 skew across 9 questions), a length-margin pass fixed 12 questions over the 25% threshold, a Jaccard overlap check caught and fixed one near-duplicate question (reworded from a bare N-N/S-S recall stem into a toy-horseshoe-magnets scenario, 3 rewording passes to clear threshold), and a hint-leak check caught and fixed one definitional-hint leak (an INSULATOR question&#39;s correct option originally said &quot;insulating sleeve&quot;, reworded to &quot;rubber bicycle grip&quot;). All three SVG diagrams (circuit loop, 3-magnet chain, combining-forces) rasterized and visually verified - two real bugs found and fixed: a caption-text-clipping bug on the combining-forces diagram (viewBox widened from 340&times;130 to 400&times;140), and a structural bug on the 3-magnet chain diagram where Magnet P was drawn at half the width of Q and R, misplacing both join labels off the true P-Q/Q-R boundaries (fixed by redrawing all three magnets as equal two-pole blocks). A wrong-answer-key bug plus self-contradictory feedback text in Lesson 2&#39;s Practice Q1 was also found via manual logic re-derivation and fixed. Scoring engine verified via a Node harness (perfect run 20/20, correct 4/6/10 split; all-wrong run 0/20). Zero hint-leak flags.' },

  lastUnit: {
    n:33, score:20, outOf:20, pct:100, delta:10, prevScore:90, passed:true,
    patternLabel: 'Unit 33 result - Biology: Plant Structures &amp; Adaptation (20/20, 100% - PERFECT)',
    patternInsight: '<strong>20/20 (100%)</strong> - PASS, PERFECT SCORE, the program&#39;s FOURTH perfect score (after U8, U21, U27). Section A (recall) = <strong>4/4 (100%)</strong>. Section B (applying, &#9733;) = <strong>6/6 (100%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>10/10 (100%)</strong>.',
    analysisLabel: 'Duckweed-roots watch-item CONFIRMED CLOSED (1st try) &middot; underground-stem 4-way classification CONFIRMED CLOSED (1st try) &middot; zero new watch-items',
    analysisInsight: 'Zero misses across all three sections, on a unit deliberately built to close two long-running watch-items. The ASMOPSS 2024 retake&#39;s duckweed-roots gap (Q25 on that paper) is CONFIRMED CLOSED - every water-plant-adaptation question, including the duckweed-specific ones, was answered correctly on the first dedicated attempt. The stale, 30+-unit-old underground-stems watch-item (last touched in Unit 1) is also CONFIRMED CLOSED - the full tuber/bulb/rhizome/corm 4-way classification, plus the storage-root-vs-stem-tuber contrast, was answered correctly across every framing tested, including the reworded farmer/corm-cutaway/dark-cupboard scenarios. No new gaps or watch-items surfaced anywhere in the test - the first unit this program to close two dedicated priority targets AND generate zero new findings in the same sitting.',
    qSummary: '<strong>20 / 20 (100%) - PASS, PERFECT.</strong> All three sections went perfect. Headline: BOTH priority watch-items (duckweed-roots, underground-stem classification) CLOSED on the first attempt, with zero new gaps surfacing - the cleanest result of the entire final-5-unit stretch so far.',
    qBreakdown: []
  },
  ...
  radarCurrent:  [89, 94, 93, 91, 95, 95],
