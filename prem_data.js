...
var PREM_DATA = {
  ...
  currentUnit: { n:46, topic:'Biology: Reproduction in Plants (school-aligned)', status:'&#9989; Ready to start &mdash; built 6 Sep 2026. Fourth unit of the 7-unit school-aligned block, matching Chapter 4 of Prem&#39;s Y5 i-Science course book. Recaps Unit 25&#39;s sexual reproduction in flowering plants (pollination, fertilisation, seed formation) and Unit 33&#39;s underground stems, then extends with genuinely new content: reproduction from spores (ferns, mosses) and reproduction from other plant parts (runners, cuttings), plus comparing all methods (sexual vs asexual). Lesson 1 opens with a spiral-maintenance warm-up from Biology Unit 17 (ecosystems/food chains, stale since mid-July 2026). Test: 20 questions, tier-tagged (2 Basic/6 Intermediate/12 Applied, per the standing U43-U49 reweighting rule), Section C sourced as genuine cross-topic synthesis from U4/U25/U33/U36/U44/U45. A lesson-vs-test and cross-corpus overlap sweep caught and rewrote 3 near-duplicate questions before shipping (see project memory).' },

  lastUnit: {
    n:45, score:20, outOf:20, pct:100, passBar:16, delta:10, prevScore:90, passed:true,
    patternLabel: 'Unit 45 result - Biology: Reproduction in Animals, school-aligned (20/20, 100% PERFECT)',
    patternInsight: '<strong>20/20 (100%)</strong> - PERFECT, the program&#39;s SIXTH perfect score (after U8, U21, U27, U33, U36) and the first inside the school-aligned block. Section A = <strong>2/2</strong>. Section B = <strong>6/6</strong>. Section C = <strong>12/12</strong>. Tier breakdown matches section breakdown exactly: Basic 2/2, Intermediate 6/6, Applied 12/12 (100%). Zero misses anywhere.',
    analysisLabel: 'Every cross-topic Applied question held clean, on genuinely new content (sexual reproduction, internal/external fertilisation, three metamorphosis types)',
    analysisInsight: '<strong>A clean sweep across all five cross-topic synthesis items and both deliberately harder-than-usual redesigned Applied questions.</strong> n10 (U4 binary-fission-vs-sexual-reproduction), n11 (U44 fertilised-egg-to-kitten cell division), n12 (U25 pollination-vs-fertilisation comparison), and n13 (U36 fair-test design) all held correct. Trap-Recognition Drill #9 (&quot;ALL animals go through metamorphosis&quot;) held. Both of the cycle&#39;s hardest-designed items held too: n16 (praying-mantis-vs-moth compare-and-explain, rebuilt from a near-duplicate flag) and n17 (the sea-turtle internal-fertilisation-despite-later-egg-laying trick question). U44&#39;s carried-forward quantity-vs-rate confusion was touched only incidentally (n11) and showed no sign of recurrence, though it remains supportively rather than fully graded-confirmed closed.',
    qSummary: '<strong>20 / 20 (100%) - PERFECT.</strong> Section A 2/2, Section B 6/6, Section C 12/12. Third real-taken result of the 7-unit school-aligned block, and its first perfect score. Strong real-condition evidence the recap-then-extend structure and 2/6/12 tier split continue to hold up on brand-new content. Confirmed next assessment: Unit 46, Biology: Reproduction in Plants (school-aligned), matching Chapter 4 of the course book.',
    qBreakdown: []
  },

  skills: [
    { name: 'Biology',                  c: 90, t: 85, ev:'U4 Microorganisms 15/15 PERFECT + U8 Photosynthesis 20/20 PERFECT + U11 Human Body Systems 20/20 PERFECT + U14 Cells 19/20 (95%) + U17 Ecosystems 17/20 (85%) - closed G4 Q40, the U1 Q13 gas-exchange thread, and Competition Q24/Q7/Q14/Q32 (Q31 substantially closed) + U20 Gap-Closure Checkpoint 16/20 (80%) - upgraded germination-light to a confirmed recurring gap + Milestone Test 2 36/40 (95%) - three of the four misses were Biology, all isolated single-fact recall slips + U22 Nutrition, Vitamins &amp; a Balanced Diet 15/20 (75%, FAIL) - the third program fail; a precise symptom-to-nutrient reverse-reasoning gap found + U25 Seeds, Plant Reproduction &amp; Dispersal 14/20 (70%, FAIL) - the stamen/pistil confusion CONFIRMED across two formats, the Iron/oxygen fact failed a THIRD consecutive attempt + U26&#39;s two embedded Biology re-test questions (within the Physics test): BOTH gaps CLOSED on the escalated first attempt - Iron (Q9, a delivery-truck-analogy Quick Fix, 4th framing) and stamen/pistil (Q10, a sorting-mini-game Quick Fix, 3rd framing) both answered correctly, confirming the escalation-to-a-different-teaching-device strategy worked for both of these long-running gaps + Milestone Test 3 34/40 (90%): the anther-vs-ovary confusion REGRESSED (Q10) after being closed by U30, germination-light reactivated at bare recall (Q9) despite a correct critique-level answer later in the same test, but the anther-vs-stigma applied check (Q32) held - directly targeted by U31&#39;s Quick Fix and new Classification/Digestion content + U31 Classification &amp; Digestion 16/20 (80%, PASS): the anther-vs-ovary Quick Fix FAILED both dedicated confirming reps identically (Q8, Q16) - a THIRD consecutive miss on this fact across M2&#8594;M3&#8594;U31, now escalated to a genuinely different teaching device (3-way JOB-sort mini-game) in U32; germination-light fully RESOLVED (Q4, Q17); two new gaps found (Q15 analogy-transfer, Q19 fair-test variable confusion) - independently reinforced by an ASMOPSS 2024 G4 Set B retake (1 Aug 2026) missing the identical anther/stigma diagram swap a month apart (Q32) + U44 Cells &amp; Cell Division (school-aligned) 18/20 (90%, PASS): the program&#39;s first Biology unit built under the 2/6/12 tier reweighting; Section A and B both perfect, both misses (Q12, Q17) traced to ONE shared confusion - mistaking total cell quantity/body size for the active division rate/purpose happening right now - rather than two unrelated gaps, enabling a single targeted fresh-scene confirming rep in U45 rather than two + U45 Reproduction in Animals (school-aligned) 20/20 (100%, PERFECT) - the program&#39;s SIXTH perfect score and the first inside the school-aligned block; every cross-topic Applied question held clean on genuinely new content (sexual reproduction, internal/external fertilisation, three metamorphosis types), Trap-Recognition Drill #9 held, and both deliberately-harder redesigned Applied items held; the U44 quantity-vs-rate confusion showed no sign of recurrence though remains only incidentally rather than fully graded-confirmed closed' },
    { name: 'Chemistry / Matter',       c: 91, t: 85, ev:'U5 States/Materials 13/15 (87%) + U9 Reactions 18/20 (90%) + U12 Materials Origins &amp; Classification 19/20 (95%) + U15 Density &amp; Buoyancy 18/20 (90%) - closed G4 Q2, Q17, and Competition Q29/Q19 + U20 Gap-Closure Checkpoint 16/20 (80%) + Milestone Test 2 36/40 (95%) - a clean run with ZERO Chemistry-related misses; every density/materials-adjacent Section B/C question was answered correctly + U24 Density, Buoyancy &amp; Thermal Expansion 19/20 (95%) - CONFIRMS Competition C2&#39;s Q27 (density calculation) and Q30 (buoyancy vs temperature) both closed; the one miss (Q16, heated balloon) reads as a framing-specific slip since the identical logic was answered correctly twice elsewhere in the same test + U40 Mixtures, Solutions &amp; Separating Materials 14/20 (70%, FAIL) - a new sieve-vs-filter vocabulary swap drove 3 of 6 misses, sitting between an abstract-trap-recognition success (Q9) and a concrete-decision miss (Q7) on the same fact, plus an explain-succeeds/critique-fails split (Q16 vs Q18); Applied tier was actually the strongest section at 90%, so the gap is narrow and vocabulary-specific rather than broad; dedicated fresh-scene coverage folded into Milestone Test 4 + Milestone Test 4 36/40 (91%, PASS) - the sieve/filter/evaporate multi-step critique (Q34) was missed AGAIN despite dedicated fresh-scene coverage, now a CONFIRMED 2-instance pattern (U40 Q18, M4 Q34) both on the multi-step-critique format specifically; escalated in Unit 41 to a brand-new click-based &quot;Find the Flaw&quot; device rather than another MCQ + U41 Acids, Bases &amp; Chemical vs Physical Change 15/20 (75%, FAIL) - a fresh, brand-new-topic gap: acid/base IDENTITY confusion (not sieve/filter/evaporate, which actually IMPROVED) drove 3 of 5 misses across litmus-reading and everyday-substance-classification questions; a milder new overgeneralization trap also surfaced on the evaporation-recovery fact, and an isolated litmus-strength trap-recognition miss; folded into Unit 42&#39;s opening Quick Fix as two fresh-scene confirming reps' },
    { name: 'Physics',                  c: 95, t: 85, ev:'U3 Magnetism &amp; Heat 15/15 PERFECT + U6 Circuits 14/15 (93%) + U10 Forces 19/20 (95%) + U13 Light 14/20 (70%, FAIL, later fully closed) + U16 Sound 17/20 (85%) + U18 Energy Transformations 15/20 (75%, FAIL) + U19 Water Cycle 17/20 (85%, PASS, PE/KE swap CONFIRMED CLOSED) + U20 Gap-Closure Checkpoint 16/20 (80%) - Competition Q30 (tides) CONFIRMED CLOSED + Milestone Test 2 36/40 (95%) + U21 Falling Objects, Gravity &amp; Air Resistance 20/20 (100%) PERFECT - CONFIRMS the Competition C2 gravity gap closed on the first attempt + U23 Static Electricity &amp; Electric Charges 16/20 (80%, PASS) - CONFIRMS Competition C2&#39;s Q17b (electrostatic induction) closed across four question framings + U26 Speed, Distance &amp; Time 19/20 (95%, PASS) - Section C (applied reasoning) went a PERFECT 10/10 on a brand-new topic, confirming clean transfer; one isolated bare-formula-recall slip (Q3, Time formula numerator/denominator swap) did not carry into either applied time-calculation question later in the same test + Milestone Test 3 34/40 (90%): two previously-solid facts cracked for the first time under fresh framings - air resistance/gravity (Q2, perfect since U21) and electrostatic induction (Q19, closed across four U23 framings) - plus Speed/Distance formula bare-recall inversions (Q11/Q25) despite correct applied use elsewhere in the same test; force-for-distance (Q15) held as an encouraging confirming rep + U34 Electricity, Magnetism &amp; Forces Recap 17/20 (85%, PASS): both carried-forward ASMOPSS 2024 retake watch-items (magnet-vs-magnetic-material, 3-magnet chain reading) landed as PARTIAL closures at 2/3 each - the magnet-material distinction held except on a &quot;what does this tell us&quot; reverse-inference format (Q6), and the chain method held except on the multi-step derivation (Q11); an isolated conductor/insulator slip (Q2) also surfaced + U39 Gravity, Forces &amp; Working-Memory Stress Test 19/20 (95%, PASS) - directly re-tested two real ASMOPSS 2026 findings under harder conditions and BOTH held clean: the gravity equal-fall-rate rule (Q1, Q14) and the magnet-chain-with-a-flip skill (Q13), both confirming exam-day rushing rather than a genuine content gap; the one miss (Q17) was a brand-new 3-object air-resistance ranking format, never asked before, cracking on first exposure while every 2-object version in the same test held correct + Milestone Test 4 36/40 (91%, PASS) - the U39 3-object air-resistance ranking rep (Q30) held CLOSED this time, but an isolated new slip surfaced on Unit 32&#39;s heat-transfer-by-radiation-across-a-vacuum fact (Q4), with no other Unit 32 items nearby to corroborate a broader pattern + U42 Circuits Deep Dive: Series vs Parallel 20/20 (100%, PERFECT) - the program&#39;s sixth perfect score; every genuine cross-topic synthesis question held (energy chain, conductor/insulator, fair-test design) and the deliberately-contrasting switch-placement pair (switch before vs after a branch split) both correct on brand-new content with no prior teaching to lean on' },
    { name: 'Earth &amp; Space',            c: 92, t: 85, ev:'U7 Astronomy 15/15 PERFECT - closed G4 Q32 (final baseline miss); jumped from 50% (untested) to above target in one unit. Untested in M2 (U11-U19 scope); Competition C2 surfaced two new Earth &amp; Space extension gaps (heliocentric/geocentric Venus phases, hemisphere-reversed seasons) slated for U27/U28 + U27 Models of the Solar System 20/20 (100%) PERFECT - CONFIRMS Competition C2&#39;s Q23 gap (heliocentric vs geocentric, Venus&#39;s phases) CLOSED on the first attempt, zero misses across all three sections + U28 Earth&#39;s Tilt &amp; the Seasons 16/20 (80%, PASS right at the bar) - Competition C2&#39;s Q25 gap (hemisphere-reversed seasons) is only PARTIALLY closed: the reversal rule holds when the season word is given directly or reasoned about abstractly, but breaks down when Prem must first derive one hemisphere&#39;s season himself before flipping it (Q6, Q10); a related distance-myth-bust gap also surfaced (Q9, Q18) - both directly targeted by U29&#39;s opening Quick Fix + U43 The Solar System, school-aligned 19/20 (95%, PASS) - the FIRST unit of the new 7-unit school-aligned block; both newly-added Applied-tier synthesis questions (life-support conditions, satellite-outage cross-topic) held correct; the one miss (Q10, satellite solar-panel tracking) was an isolated absolute-claim trap, not a broader gap' },
    { name: 'Scientific Investigation', c: 95, t: 85, ev:'Section C 80% (U1), 100% (U2-U8), 90% (U9), 100% (U10), 100% (Milestone 1, 8/8), 100% (U11-U12), 60% (U13), 100% (U14), 90% (U15), 80% (U16-U20) + Milestone Test 2: Section C 8/8 (100%) - a PERFECT run + U21: Section C 10/10 (100%) PERFECT + U22: Section C 8/10 (80%) - a new, first-exposure gap surfaced: interpreting a fair test that shows NO difference as still a valid result + U23: Section C 8/10 (80%) - the null-result fair-test gap did NOT close despite direct remediation, escalated to U24 + U24: Section C 9/10 (90%) - the null-result fair-test gap is finally RESOLVED after escalating to a coin-flip fairness analogy + U25: Section C 7/10 (70%) - a step down, though the misses trace back to confirmed content gaps rather than a fresh reasoning weakness + U26: Section C 10/10 (100%) PERFECT - a full recovery, including two fresh fair-test-design questions applied to a brand-new topic, both answered correctly + U27: Section C 10/10 (100%) PERFECT - the model-testing logic (choosing between two equally-fitting ideas via a new prediction) transferred cleanly to a brand-new topic with zero misses + Milestone Test 3: Section C 8/8 (100%) PERFECT - the SECOND consecutive milestone test with a perfect applied section, now a well-established strength under exam pressure + U31: Section C 7/10 (70%) - a step back, with two of the three misses (Q8, Q16) tracing to the persistent anther-vs-ovary content gap rather than a fresh reasoning weakness, plus one genuinely new analogy-transfer miss (Q15) + Milestone Test 4: Section A 13/16 (81%) - a new gap surfaced here, not in Section C: bare-definitional recall of Unit 36&#39;s control-group and anomaly vocabulary (Q9, Q10) was missed even though Unit 36&#39;s OTHER signature skills (conductor/insulator, two-clue reverse-factor) held correct elsewhere in the same test, isolating the miss to bare terminology decay specifically rather than a fair-test reasoning regression' },
  ...
  radarCurrent:  [91, 91, 95, 92, 95, 95],
  ...
  scores: [
    ...
    { unit:40, topic:'Chemistry: Mixtures, Solutions &amp; Separating Materials', score:14, outOf:20, pct:70, passBar:16, date:'2026-08-16' },
    { unit:'M4', topic:'Milestone Test 4 - All Units (U31-U40)', score:36, outOf:40, marks:91.25, marksOutOf:100, pct:91, passBar:32, date:'2026-08-17' },
    { unit:41, topic:'Chemistry: Acids, Bases &amp; Chemical vs Physical Change', score:15, outOf:20, pct:75, passBar:16, date:'2026-08-21' },
    { unit:42, topic:'Physics: Circuits Deep Dive &mdash; Series vs Parallel', score:20, outOf:20, pct:100, passBar:16, date:'2026-08-28' },
    { unit:43, topic:'Earth &amp; Space: The Solar System (school-aligned)', score:19, outOf:20, pct:95, passBar:16, date:'2026-08-30' },
    { unit:44, topic:'Biology: Cells &amp; Cell Division (school-aligned)', score:18, outOf:20, pct:90, passBar:16, date:'2026-09-03' },
    { unit:45, topic:'Biology: Reproduction in Animals (school-aligned)', score:20, outOf:20, pct:100, passBar:16, date:'2026-09-04' }
  ],
  ...
  unitLog: [
    {
      n: 45, badge: 'linear-gradient(135deg,#3949ab,#8a6d00)',
      title: 'Biology: Reproduction in Animals (school-aligned)',
      tags: [
        { t:'&#127942; 20/20 (100%) PERFECT', s:'background:#e6f4ea;color:#1b5e20;font-weight:700' },
        { t:'6th perfect score of the program', c:'tgreen' },
        { t:'All 5 cross-topic questions held', c:'tgreen' },
        { t:'THIRD unit of 7-unit school-aligned block', c:'tblue' }
      ],
      note: '39th assessment of the program, and the THIRD unit of the 7-unit school-aligned block matching Chapter 3 of Prem&#39;s Y5 i-Science course book. Lesson 1 (`AnimalReproSchool_Lesson_MaleFemaleAndFertilisation.html`, indigo/gold theme) opens with a fresh-scene Quick Fix confirming rep for Unit 44&#39;s real-taken quantity-vs-rate miss pattern, then a spiral-maintenance warm-up from Physics U21 (gravity/free fall/air resistance), briefly recaps Unit 31&#39;s five vertebrate groups, then introduces genuinely new content: sexual reproduction and internal vs external fertilisation. Lesson 2 (`AnimalReproSchool_Lesson_LifeCyclesAndMetamorphosis.html`) covers the three life-cycle types (no metamorphosis, incomplete metamorphosis, complete metamorphosis), including Trap-Recognition Drill #9 (the &quot;ALL animals go through metamorphosis&quot; absolute-claim trap). Test `Tests\\Unit_45_Test_ReproductionInAnimals.html` (20Q) built under the standing 2 Basic/6 Intermediate/12 Applied tier split, Section C sourced as genuine cross-topic synthesis from U4/U11/U25/U36/U44. The mandatory lesson-vs-test per-question overlap check caught and rewrote 7 near-duplicate violations before shipping. Built and verified: position-balance exact 5/5/5/5, section/tier tally {A:2,B:6,C:12}, zero within-test or lesson-vs-test Jaccard flags, zero cross-corpus flags above 0.4 against 23 relevant files, length-margin clean, div-balance clean, scoring engine verified via a Node harness (perfect run 20/20; all-wrong run 0/20). Full 10-year-old role-play verification pass completed end-to-end. <strong>TAKEN 4 Sep 2026: 20/20 (100%) - PERFECT, the program&#39;s SIXTH perfect score</strong> (after U8, U21, U27, U33, U36), and the first inside the school-aligned block. Section A 2/2, Section B 6/6, Section C 12/12 &mdash; zero misses anywhere. Headline: every cross-topic Applied question held (n10 U4 binary-fission-vs-sexual-reproduction, n11 U44 fertilised-egg-to-kitten cell division, n12 U25 pollination-vs-fertilisation comparison, n13 U36 fair-test design), Trap-Recognition Drill #9 held (n15), and both of the cycle&#39;s hardest-designed items held (n16, the redesigned praying-mantis-vs-moth compare-and-explain question; n17, the sea-turtle internal-fertilisation trick question). U44&#39;s carried-forward quantity-vs-rate confusion showed no sign of recurrence in the graded cross-topic question that touched adjacent reasoning (n11), though it remains supportively rather than fully confirmed closed. Results saved to `Lessons\\Tests\\Results\\SCI_U045_Results_2026-09-04.json`. Confirmed next assessment: Unit 46 (Biology: Reproduction in Plants, school-aligned), the fourth unit of this block, matching Chapter 4 of the course book.',
      status: 'done'
    },
    {
      n: 44, badge: 'linear-gradient(135deg,#00695c,#003d33)',
      title: 'Biology: Cells &amp; Cell Division (school-aligned)',
      tags: [
        { t:'&#9989; 18/20 (90%) PASS', s:'background:#e6f4ea;color:#1b5e20;font-weight:700' },
        { t:'Both misses share ONE root cause', c:'tblue' },
        { t:'SECOND unit of 7-unit school-aligned block', c:'tblue' },
        { t:'Section A + B both perfect', c:'tgreen' }
      ],
      note: '38th assessment of the program, and the SECOND unit of the 7-unit school-aligned block matching Chapter 2 of Prem&#39;s Y5 i-Science course book. Lesson 1 (`Cells2School_Lesson_CellsRecapAndWhyDivide.html`, teal/coral theme) opens with a spiral-maintenance warm-up from Physics U16 (Sound, stale since mid-July), recaps Unit 14&#39;s cell-structure facts, then introduces genuinely new content: cell division and its two purposes, growth and repair. Lesson 2 (`Cells2School_Lesson_HowCellsDivideGrowthVsRepair.html`) covers the three-stage mechanism (grow &rarr; copy its parts &rarr; split in two) and growth-over-a-lifetime reasoning, including Trap-Recognition Drill #8 (the &quot;adult cells never divide again&quot; absolute-claim trap). Test `Tests\\Unit_44_Test_Cells.html` (20Q) built under the standing 2 Basic/6 Intermediate/12 Applied tier split, Section C sourced as genuine cross-topic synthesis from U4/U8/U11/U17/U36/U38. A dedicated lesson-vs-test overlap check (extracting each lesson&#39;s own graded practice questions and running per-question Jaccard against every drafted test question) caught 7 real near-duplicate violations before shipping, now folded in as standard mandatory verification infrastructure for every future unit. Built and verified: position-balance exact 5/5/5/5, section/tier tally {A:2,B:6,C:12}, zero within-test or lesson-vs-test Jaccard flags after fixes, length-margin clean, div-balance clean, scoring engine verified via a Node harness (perfect run 20/20; all-wrong run 0/20). Full 10-year-old role-play verification pass completed end-to-end. <strong>TAKEN 3 Sep 2026: 18/20 (90%) - PASS.</strong> Section A 2/2, Section B 6/6, Section C 10/12 &mdash; Basic 2/2, Intermediate 6/6, Applied 10/12 (83%). Headline: both misses (Q12, Q17) trace to ONE shared root cause &mdash; confusing total cell quantity/body size with the active division RATE/purpose happening right now, not two unrelated gaps. Results saved to `Lessons\\Tests\\Results\\SCI_U044_Results_2026-09-03.json`. Confirmed next assessment: Unit 45 (Biology: Reproduction in Animals, school-aligned), the third unit of this block, matching Chapter 3 of the course book.',
      status: 'done'
    },
    {
      n: 43, badge: 'linear-gradient(135deg,#1a237e,#0d1345)',
      title: 'Earth &amp; Space: The Solar System (school-aligned)',
      tags: [
        { t:'&#9989; 19/20 (95%) PASS', s:'background:#e6f4ea;color:#1b5e20;font-weight:700' },
        { t:'Both new Applied-tier questions held', c:'tgreen' },
        { t:'FIRST unit of 7-unit school-aligned block', c:'tblue' },
        { t:'Absolute-claim trap missed (satellite panels)', c:'torange' }
      ],
      note: '37th assessment of the program, and the FIRST unit of a NEW 7-unit school-aligned block matching Chapter 1 of Prem&#39;s Y5 i-Science course book &mdash; per Lui&#39;s 28 Aug 2026 decision, the U41-U50 ASMOPSS-track rotation is postponed after only 2 of 10 units so the next 7 units align directly with his actual school Science class. Two lessons cover genuinely new content never taught before: L1 `SolarSystemSchool_Lesson_TheSunAndEarth.html` (the Sun as a star, hot gases, energy source; Earth&#39;s three layers and life-supporting conditions), L2 `SolarSystemSchool_Lesson_MoonSolarSystemAndSatellites.html` (Moon surface features, the 8-planet order and two planet families, man-made satellites), both briefly recapping Unit 7&#39;s rotation/revolution/Moon-phases first. Opens with a spiral-maintenance warm-up from Chemistry U9/U12. Embeds Trap-Recognition Drill #7. Test `Tests\\Unit_43_Test_SolarSystem.html` (20Q) was built and then REWEIGHTED to 2 Basic/6 Intermediate/12 Applied (10/30/60%) &mdash; up from the program&#39;s standard 4/6/10 split &mdash; per Lui&#39;s 30 Aug 2026 instruction to weight all 7 school-aligned units (U43-U49) more heavily toward Intermediate &amp; Applied ASMOPSS tiers; the 2 dropped Basic facts were rewritten as harder Applied-tier synthesis questions (n19, n20) rather than cut outright. Section C sourced as genuine cross-topic synthesis from U6/U8 (energy chain, photosynthesis) and U36 (fair-test design). Built and verified: position-balanced exact 5/5/5/5, length-margin clean after a fix pass, scoring engine verified via a Node harness (perfect run 20/20 with the new {A:2,B:6,C:12} tier split; all-wrong run 0/20). Full 10-year-old role-play verification pass completed end-to-end. <strong>TAKEN 30 Aug 2026: 19/20 (95%) - PASS.</strong> Section A 2/2, Section B 6/6, Section C 11/12 &mdash; Basic 2/2, Intermediate 6/6, Applied 11/12. Headline: BOTH newly-added Applied-tier questions (Q19, the three-condition life-support synthesis; Q20, the satellite-outage cross-topic synthesis) held correct, an early positive signal for the reweighting decision on its first real outing. The one miss, Q10, asked why a weather satellite&#39;s solar panels need to track the Sun as Earth rotates &mdash; Prem picked an absolute-sounding distractor rather than the correctly-scoped explanation, an isolated single-question absolute-claim trap rather than a broader pattern (no other Q10-adjacent items missed). Results saved to `Lessons\\Tests\\Results\\SCI_U043_Results_2026-08-30.json`. Confirmed next assessment: Unit 44 (Biology: Cells &amp; Cell Division, school-aligned), the second unit of this block, matching Chapter 2 of the course book.',
      status: 'done'
    },
    {
      n: 42, badge: 'linear-gradient(135deg,#1a237e,#0d1345)',
      title: 'Physics: Circuits Deep Dive &mdash; Series vs Parallel',
      tags: [
        { t:'&#127942; 20/20 (100%) PERFECT', s:'background:#e6f4ea;color:#1b5e20;font-weight:700' },
        { t:'6th perfect score of the program', c:'tgreen' },
        { t:'Switch-placement contrast pair both correct', c:'tgreen' },
        { t:'SECOND unit of U41-U50 rotation (now paused)', c:'tblue' }
      ],
      note: '36th assessment of the program, the second unit test of the U41-U50 rotation block, directly following up on Unit 41&#39;s acid/base identity confusion with two fresh-scene confirming reps placed as ungraded Quick Fix screens in Lesson 1 (not graded here, since U41&#39;s findings were Chemistry content, not Physics). Two lessons on brand-new content never taught before in this program: L1 `PhysicsCircuits_Lesson_SeriesCircuits.html` teaches series circuits (one path, one break stops everything) with a spiral-maintenance warm-up from Unit 27/28 (Earth &amp; Space, untouched 4+ weeks). L2 `PhysicsCircuits_Lesson_ParallelCircuitsAndComparison.html` teaches parallel circuits (multiple paths, one branch breaking doesn&#39;t stop the others) and a direct series-vs-parallel comparison. Test `Tests\\Unit_42_Test_CircuitsSeriesVsParallel.html` (20Q, 4A/6B/10C, PASS_BAR 16) tier-tagged throughout, with a deliberately-contrasting switch-placement pair (Q13: switch before a branch split affects ALL branches; Q14: switch after the split on one branch affects only ONE branch) and Section C sourced as genuine cross-topic synthesis from U6 (energy chain, conductor/insulator) and U36 (fair-test design). Built and verified: position-balanced exact 5/5/5/5, length-margin clean, within-test and cross-corpus Jaccard clean, scoring engine verified via a Node harness (perfect run 20/20; all-wrong run 0/20). Full 10-year-old role-play verification pass completed end-to-end. <strong>TAKEN 28 Aug 2026: 20/20 (100%) - PERFECT, the program&#39;s SIXTH perfect score</strong> (after U8, U21, U27, U33, U36). Section A 4/4, Section B 6/6, Section C 10/10 - tier breakdown matches section breakdown exactly, zero misses anywhere. Headline: every dedicated confirming rep and genuine cross-topic synthesis question held clean on brand-new content with no prior teaching to lean on - the energy-chain (Q11) and conductor/insulator (Q12) cross-topic questions both correct, the fair-test-design cross-topic question (Q17) and the Applied-tier trap-recognition item (Q16, &quot;one bulb dark always means the whole circuit is broken&quot; - false) both correct, Trap-Recognition Drill #6 held, and critically the deliberately-contrasting switch-placement pair (Q13/Q14) - the first real test of whether this distinction transfers cleanly - both came back correct. U41&#39;s two carried-forward findings (acid/base identity, chemical-irreversibility overgeneralization) were placed as UNGRADED Quick Fix screens per the standing convention, so their pass/fail isn&#39;t captured in this results file. Results saved to `Lessons\\Tests\\Results\\SCI_U042_Results_2026-08-28.json`. <strong>Per Lui&#39;s 28 Aug 2026 decision, the U41-U50 ASMOPSS-track rotation is now POSTPONED after only 2 of 10 units</strong> - the next 7 units pivot to align directly with Prem&#39;s actual school Science class, using his Y5 i-Science course book (7 chapters, matching &quot;next 7 units&quot;) as the curriculum source. Confirmed next assessment: Unit 43 (Earth &amp; Space: The Solar System, school-aligned), the first unit of this new block, built 28-30 Aug 2026 with tier weighting shifted to 2 Basic/6 Intermediate/12 Applied (10/30/60%) per Lui&#39;s instruction to weight all 7 school-aligned units more heavily toward Intermediate &amp; Applied ASMOPSS tiers.',
      status: 'done'
    },
    {
      n: 41, badge: 'linear-gradient(135deg,#c2185b,#00838f)',
      title: 'Chemistry: Acids, Bases &amp; Chemical vs Physical Change',
      tags: [
        { t:'&#10060; 15/20 (75%) FAIL', s:'background:#fdecea;color:#c62828;font-weight:700' },
        { t:'Acid/base identity confusion drove 3/5 misses', c:'torange' },
        { t:'Sieve/filter/evaporate gap actually improved', c:'tgreen' },
        { t:'FIRST unit of U41-U50 rotation', c:'tblue' }
      ],
      note: '35th assessment of the program, the first unit test of the fresh U41-U50 rotation block opened after Milestone Test 4 closed U31-U40. Brand-new topic never given dedicated coverage before: acid/base testing via litmus paper, plus the deeper evidence-based signs of chemical vs physical change, capped by a worked vinegar + baking soda reaction bridging both lessons. Lesson 1 opened with a REDESIGNED escalation device (a click-based &quot;Find the Flaw&quot; mini-game, genuinely different from two prior failed MCQ attempts) targeting the sieve/filter/evaporate critique-format gap, then confirmed 2-instance pattern from U40 Q18 and Milestone 4 Q34, plus a Biology U31 spiral-maintenance warm-up. Test `Tests\\Unit_41_Test_AcidsBasesAndChemicalChange.html` (20Q, 4A/6B/10C, PASS_BAR 16) tier-tagged throughout, with Section C sourced as genuine cross-topic synthesis from U2/U9/U36/U37/U40. Built and verified: position-balanced, length-margin clean, scoring engine verified via a Node harness. <strong>TAKEN 21 Aug 2026: 15/20 (75%) - FAIL</strong>, the first fail of the new rotation. Section A 2/4 (50%), Section B 5/6 (83%), Section C 8/10 (80%) - an inverted-difficulty pattern, easiest tier scoring worst. Five misses: Q1, Q2, Q9, Q13, Q18. Headline finding: Q1 (soil litmus test), Q2 (everyday acid ID), and Q9 (vinegar + baking soda substance types) all point the same way - a genuine ACID/BASE IDENTITY confusion, not a shaky isolated fact. Second finding: Q18 (recovering a dissolved solid) shows the sieve/filter/evaporate gap has actually IMPROVED - sieving/filtering was correctly ruled out - but overgeneralized into a new absolute claim (&quot;no method could ever recover it&quot;) instead of naming evaporation. Third finding: Q13, an isolated trap-recognition miss, mistook litmus colour intensity for a strength measurement. Overall shape: the third consecutive real-condition test where Basic tier scored softest even as Applied tier held strong (80%). Results saved to `Lessons\\Tests\\Results\\SCI_U041_Results_2026-08-21.json`. Confirmed next assessment: Unit 42 (Physics: Circuits Deep Dive - Series vs Parallel), the second unit of the U41-U50 rotation block, built 27 Aug 2026 with two fresh-scene confirming reps for the acid/base identity confusion folded into its opening Quick Fix.',
      status: 'done'
    },
    {
      n: 'M4', badge: 'linear-gradient(135deg,#DAA520,#8a6a00)',
      title: 'Milestone Test 4 &mdash; All Units (U31&ndash;U40)',
      tags: [
        { t:'&#9989; 36/40, 91.25/100 (91%) PASS', s:'background:#e6f4ea;color:#1b5e20;font-weight:700' },
        { t:'Beat Milestone 3 baseline (+1.3 marks)', c:'tgreen' },
        { t:'Sieve/filter critique gap now 2-instance', c:'torange' },
        { t:'New U36 bare-vocabulary decay found', c:'torange' }
      ],
      note: '34th assessment of the program, fourth milestone test, closing the U31-U40 rotation block (the tenth unit test since Milestone Test 3, per the standing 10-unit-test cadence). 40 questions, weighted marks (1.25/2.5/5, 100 total, PASS_MARKS 80), tier-tagged (Basic/Intermediate/Applied) for the first time on a milestone test. Dedicated coverage: the anther-vs-ovary/stigma confirming rep, Unit 39&#39;s 3-object air-resistance ranking rep, and Unit 40&#39;s sieve/filter/evaporate swap gap touched four times with genuinely different cognitive tasks and scenes. <strong>TAKEN 17 Aug 2026: 36/40, 91.25/100 marks (91%) - PASS</strong>, beating Milestone 3&#39;s 90/100 baseline by 1.3 marks. Section A 13/16, Section B 16/16 (perfect), Section C 7/8. Four misses: Q4, Q9, Q10, Q34. Headline findings: every confirming rep held except one - the anther/stigma rep (Q17), the 3-object ranking rep (Q30), and two of three sieve/filter/evaporate touches (Q31, Q33) all held correct, and Section B ran a perfect 16/16. A new finding surfaced: Q9 and Q10, both bare-definitional Unit 36 vocabulary (control group, anomaly), were missed even though Unit 36&#39;s OTHER signature skills (conductor/insulator, two-clue reverse-factor) held correct elsewhere in the same test - isolating this to bare terminology decay specifically. Q4 (Unit 32 radiation-across-a-vacuum) was an isolated slip with no corroborating pattern. The headline finding: Q34, the fourth and most demanding sieve/filter/evaporate touch (a multi-step critique of a flawed separating plan), was missed - the SAME critique-format failure shape as Unit 40&#39;s Q18, now a confirmed 2-instance pattern across two real tests. Results saved to `Lessons\\Tests\\Results\\SCI_M04_Results_2026-08-17.json`. Confirmed next assessment: Unit 41 (Chemistry: Acids, Bases &amp; Chemical vs Physical Change), the first unit of a fresh U41-U50 rotation block, built 18 Aug 2026 with a brand-new click-based &quot;Find the Flaw&quot; escalation device directly targeting the sieve/filter/evaporate critique-format gap.',
      status: 'done'
    },
    {
      n: 40, badge: 'linear-gradient(135deg,#6a1b9a,#4a148c)',
      title: 'Chemistry: Mixtures, Solutions &amp; Separating Materials',
      tags: [
        { t:'&#10060; 14/20 (70%) FAIL', s:'background:#fdecea;color:#c62828;font-weight:700' },
        { t:'Sieve-vs-filter swap drove 3 of 6 misses', c:'torange' },
        { t:'Applied tier actually strongest (90%)', c:'tgreen' },
        { t:'FOURTH &amp; FINAL unit before Milestone 4', c:'tblue' }
      ],
      note: '33rd assessment of the program, fourth and final unit test of the post-ASMOPSS 2026 rotation block (Executive Summary &sect;50) before Milestone Test 4. Covered mixtures, solutions, and the three core separating methods - sieving, filtering, and evaporating - plus dissolving/solubility. Test `Tests\\Unit_40_Test_MixturesSolutionsSeparatingMaterials.html` (20Q, 4A/6B/10C, PASS_BAR 16) was the first unit test built entirely under the mandatory tier-tagging standard, with every question carrying a Basic/Intermediate/Applied tier field and the saved results JSON reporting a tier-split array alongside the section-split. Built and verified: position-balanced, length-margin clean, cross-corpus overlap clean, hint-leak clean, scoring engine verified via a Node harness. <strong>TAKEN 16 Aug 2026: 14/20 (70%) - FAIL</strong>, the program&#39;s sixth failed unit test. Section A 3/4 (75%), Section B 2/6 (33%), Section C 9/10 (90%) - Basic 3/4, Intermediate 2/6, Applied 9/10, an inverted-difficulty pattern with the hardest tier scoring best. Six misses: Q3, Q5, Q6, Q7, Q8, Q18. Headline: a sieve-vs-filter vocabulary swap was the dominant driver, accounting for 3 of the 6 misses - Prem consistently named the wrong method when the two were both plausible in a mixed-solid scenario. A second finding: abstract trap-recognition succeeded (Q9, correct) where the identical underlying fact framed as a concrete decision failed (Q7, missed) - the vocabulary gap is decision-application-specific, not a recall gap. A third finding: an explain-the-method question succeeded (Q16) where a multi-step critique-someone-else&#39;s-method question on the same fact failed (Q18). Applied tier was actually Prem&#39;s BEST section at 90%, so the overall gap reads as narrow and vocabulary-specific rather than a broad content collapse. Results saved to `Lessons\\Tests\\Results\\SCI_U040_Results_2026-08-16.json`. Confirmed next assessment: Milestone Test 4 (All Units, U31-U40), the tenth and final unit test of this rotation block, built 16 Aug 2026 with dedicated fresh-scene coverage folding in all three findings above (four separate sieve/filter/evaporate touches across different cognitive tasks, plus the still-owed anther/ovary and 3-object-ranking confirming reps from U37-U39).',
      status: 'done'
    },
    {
