...
var PREM_DATA = {
  ...
  currentUnit: { n:33, topic:'Biology: Plant Structures &amp; Adaptation', status:'Test ready &middot; two lessons (How Plants Adapt to Where They Live; A Closer Look at Underground Stems) + a 20Q test (4A/6B/10C, pass bar 16/20). Third of the final 5 units before ASMOPSS 2026 (9 Aug). Lesson 1 `PlantAdaptations_Lesson_DesertAndWaterPlants.html` (green, 8 screens) opens with a Quick Recall of Unit 1&#39;s root/stem/leaf jobs, then teaches desert-plant adaptations (cactus: spines as reduced leaves, thick water-storing stem, wide shallow roots) and water-plant adaptations (duckweed: floating leaves, short non-anchoring roots since the water itself supports the plant) - directly targeting the ASMOPSS 2024 retake&#39;s duckweed-roots watch-item (Q25). Lesson 2 `PlantAdaptations_Lesson_UndergroundStemsCloserLook.html` (blue, 7 screens) recaps Unit 1&#39;s buds/eyes test (potato = stem, not root) then deepens it into a full tuber/bulb/rhizome/corm classification (potato/onion/ginger/taro) plus a storage-root-vs-stem-tuber contrast (sweet potato/carrot vs potato) - directly targeting the stale, 30+-unit-old underground-stems watch-item. Both lessons include a decision tree and 5Q practice. Test `Tests\\Unit_33_Test_PlantStructuresAndAdaptation.html` (20Q, 4A/6B/10C, PASS_BAR 16) covers desert/water adaptations, duckweed specifically, all four underground stem types, storage roots, general Unit-1 recall, and applied/fair-test reasoning - built with fresh scenarios (mint, turmeric, yam, beet, water hyacinth, garlic) distinct from both lessons&#39; own practice questions. Built and verified: position-balanced exact 5/5/5/5, a length-margin pass fixed 15 questions over the 25% threshold via trimming/lengthening, a Jaccard overlap check caught and fixed 3 near-duplicate question stems echoing the lessons&#39; own practice wording (rewritten with new scenarios: a beet-harvesting farmer, a solid-vs-layered corm cut-away, a potato sprouting in a dark cupboard). All three SVG diagrams (cactus, duckweed, tuber/bulb/rhizome/corm comparison) rasterized and visually verified - one text-clipping bug on the duckweed diagram found and fixed (viewBox widened from 320 to 400). Scoring engine verified via a Node harness (perfect run 20/20, correct 4/6/10 split; all-wrong run 0/20). Zero hint-leak flags.' },

  lastUnit: {
    n:32, score:18, outOf:20, pct:90, delta:10, prevScore:80, passed:true,
    patternLabel: 'Unit 32 result - Physics: Heat, Temperature &amp; Materials (18/20, 90% - PASS)',
    patternInsight: '<strong>18/20 (90%)</strong> - PASS. Section A (recall) = <strong>4/4 (100%)</strong>. Section B (applying, &#9733;) = <strong>6/6 (100%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>8/10 (80%)</strong>.',
    analysisLabel: 'Anther/stigma/ovary 3-bin sort-game escalation WORKED (1st attempt) &middot; two new Section C gaps (cold-metal illusion, simultaneous multi-transfer)',
    analysisInsight: 'Both dedicated confirming reps for the escalated anther-vs-ovary/stigma 3-way click-to-sort mini-game were answered correctly (Q1 bare-recall stigma question, Q11 the harder 3-part applied bee-pollination ordering question) - the THIRD confirmed instance of the program&#39;s "escalate to a genuinely different, more concrete teaching device after a lighter fix fails" strategy working on the very first attempt, after Iron/oxygen (U26) and stamen/pistil (U26) both closed the same way. Per Milestone Test 3&#39;s durability finding that previously-closed facts can crack again under long, cumulative-paper conditions, one more confirming rep at a future milestone/mock-test level is still warranted before fully retiring this watch-item. Two new, first-exposure gaps surfaced in Section C: Q12, a "cold metal illusion" critique question (a metal spoon feels colder than a wooden spoon despite both being at the same room temperature - the conduction-speed explanation was not applied), and Q16, a simultaneous multi-transfer-type identification question (a campfire scene showing conduction, convection, and radiation all at once was not recognized as all three together, despite each individual transfer type being answered correctly elsewhere in the same test).',
    qSummary: '<strong>18 / 20 (90%) - PASS.</strong> Sections A and B both went perfect. Headline: the escalated anther/stigma/ovary 3-bin sort-game Quick Fix worked cleanly on the first attempt, closing a fact that had failed on 3 consecutive prior assessments. Two new Section C gaps surfaced: a cold-metal illusion critique miss, and a simultaneous multi-transfer-type identification miss - both fold into Unit 33&#39;s coaching focus.',
    qBreakdown: []
  },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'Third of the final 5 units', c:'torange' },
        { t:'Duckweed + underground stems', c:'tgreen' },
        { t:'ASMOPSS retake watch-items', c:'tblue' }
      ],
