...
var PREM_DATA = {
  ...
  currentUnit: { n:44, topic:'Biology: Cells &amp; Cell Division (school-aligned)', status:'&#9989; Ready to start &mdash; built 30 Aug-2 Sep 2026. Second unit of the 7-unit school-aligned block, matching Chapter 2 of Prem&#39;s Y5 i-Science course book. Lesson 1 opens with a spiral-maintenance warm-up from Physics U16 (Sound, stale since mid-July and untouched by Milestones 3 or 4), recaps Unit 14&#39;s cell-structure facts (plant vs animal cell parts, unicellular vs multicellular), then introduces genuinely new content: cell division and its two purposes, growth and repair. Lesson 2 covers the three-stage mechanism (grow &rarr; copy its parts &rarr; split in two) and growth-over-a-lifetime reasoning (division slows for growth but never stops for repair), including Trap-Recognition Drill #8 (the &quot;adult cells never divide again&quot; absolute-claim trap). Test: 20 questions, tier-tagged (2 Basic/6 Intermediate/12 Applied, per the standing U43-U49 reweighting rule), Section C sourced as genuine cross-topic synthesis from U4/U8/U11/U17/U36/U38. A lesson-vs-test overlap sweep caught and rewrote 7 near-duplicate questions before shipping (see feedback-no-near-duplicate-confirming-reps in project memory).' },

  lastUnit: {
    n:43, score:19, outOf:20, pct:95, passBar:16, delta:-5, prevScore:100, passed:true,
    patternLabel: 'Unit 43 result - Earth &amp; Space: The Solar System, school-aligned (19/20, 95% PASS)',
    patternInsight: '<strong>19/20 (95%)</strong> - PASS. Section A = <strong>2/2</strong>. Section B = <strong>6/6</strong>. Section C = <strong>11/12</strong>. Tier breakdown matches section breakdown exactly: Basic 2/2, Intermediate 6/6, Applied 11/12. One miss.',
    analysisLabel: 'Both newly-added Applied-tier questions (Q19, Q20) held correct, an early positive signal for the 2/6/12 reweighting decision &middot; one absolute-claim-trap miss on satellite solar panels (Q10)',
    analysisInsight: '<strong>Both newly-added Applied-tier synthesis questions held correct on their first real outing.</strong> Q19 (three-condition life-support synthesis) and Q20 (satellite-outage cross-topic synthesis) - the two questions written to replace the dropped Basic-tier facts under the new 2/6/12 tier split - both correct, an encouraging early signal for that reweighting decision. The one miss, Q10, asked why a weather satellite&#39;s solar panels need to track the Sun as Earth rotates; Prem picked an absolute-sounding distractor rather than the correctly-scoped explanation - reads as an isolated single-question absolute-claim trap rather than a broader pattern, since no other satellite or Earth-rotation item nearby was missed.',
    qSummary: '<strong>19 / 20 (95%) - PASS.</strong> Section A 2/2, Section B 6/6, Section C 11/12. First real-taken result of the new 7-unit school-aligned block and the first test built under the 2 Basic/6 Intermediate/12 Applied reweighting - both dedicated new Applied-tier questions held clean. Confirmed next assessment: Unit 44, Biology: Cells &amp; Cell Division (school-aligned), matching Chapter 2 of the course book.',
    qBreakdown: []
  },
  ...
  radarCurrent:  [89, 91, 95, 92, 95, 95],
