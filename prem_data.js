...
var PREM_DATA = {
  ...
  currentUnit: { n:42, topic:'Physics: Circuits Deep Dive &mdash; Series vs Parallel', status:'&#9989; Ready to start &mdash; built 27 Aug 2026. Second unit of the U41-U50 rotation block, extending Unit 6&#39;s complete-circuit basics and Unit 34&#39;s conductor/insulator recap into genuinely new content: series vs parallel wiring and what happens when one component fails. Lesson 1 opens with two ungraded Quick Fix confirming reps for Unit 41&#39;s acid/base identity confusion (fresh scenes), then an Earth &amp; Space (U27/U28) spiral-maintenance warm-up, before teaching series circuits and the &quot;one gap breaks everything&quot; rule via the old-Christmas-lights problem. Lesson 2 teaches parallel circuits, Trap-Recognition Drill #6 (&quot;more bulbs doesn&#39;t always mean parallel&quot;), and contrasts both wiring types via old Christmas lights vs a real house. Test: 20 questions, tier-tagged throughout, Section C sourced as genuine cross-topic synthesis from U6 (energy chain, conductor/insulator) and U36 (fair-test design) rather than harder versions of the just-taught lesson, per the standing Science protocol.' },

  lastUnit: {
    n:41, score:15, outOf:20, pct:75, passBar:16, delta:-16, prevScore:91, passed:false,
    patternLabel: 'Unit 41 result - Chemistry: Acids, Bases &amp; Chemical vs Physical Change (15/20, 75% FAIL)',
    patternInsight: '<strong>15/20 (75%)</strong> - FAIL, the first fail of the new U41-U50 rotation, following Milestone 4&#39;s 91% PASS. Section A = <strong>2/4 (50%)</strong>. Section B = <strong>5/6 (83%)</strong>. Section C = <strong>8/10 (80%)</strong>. Tier breakdown matches section breakdown: Basic 2/4, Intermediate 5/6, Applied 8/10 - an inverted-difficulty pattern, with the easiest tier scoring worst.',
    analysisLabel: 'Acid/base identity confusion drove 3 of 5 misses &middot; a litmus-strength trap caught &middot; evaporation-recovery overgeneralized as impossible &middot; Basic tier now the softest tier on three straight real-condition tests',
    analysisInsight: 'Five misses: Q1, Q2, Q9, Q13, Q18. <strong>Headline finding:</strong> Q1 (a soil sample&#39;s litmus result), Q2 (identifying an everyday acid), and Q9 (naming the two substance types in a vinegar + baking soda reaction) all point the same way - a genuine mix-up between the ACID and BASE identity signatures, not a shaky isolated fact. This directly shaped Unit 42&#39;s Lesson 1, which opens with two fresh-scene confirming reps on exactly this confusion. <strong>Second finding:</strong> Q18 (recovering a dissolved solid after a reaction) shows the sieve/filter/evaporate gap has genuinely IMPROVED - Prem correctly ruled out sieving/filtering - but overgeneralized into a NEW absolute claim (&quot;no method could ever recover it&quot;) instead of naming evaporation, trading one gap for a milder trap-recognition one. <strong>Third finding:</strong> Q13, an isolated trap-recognition miss, mistook litmus colour INTENSITY for a strength measurement rather than a simple acid/base indicator. <strong>Overall shape:</strong> the third consecutive real-condition test where the Basic tier scored softest, even as Applied tier held strong (80%) - reinforcing that Basic-tier misses trace to precision/reading-the-question issues more than content gaps.',
    qSummary: '<strong>15 / 20 (75%) - FAIL,</strong> the first fail of the new U41-U50 rotation. Section A 2/4, Section B 5/6, Section C 8/10. Headline: an acid/base identity mix-up drove 3 of 5 misses, folded into Unit 42&#39;s opening Quick Fix as two fresh-scene confirming reps. Confirmed next assessment: Unit 42 (Physics: Circuits Deep Dive - Series vs Parallel), the second unit of the U41-U50 rotation block.',
    qBreakdown: []
  },
  ...
  radarCurrent:  [89, 91, 93, 91, 95, 95],
