...
var PREM_DATA = {
  ...
  currentUnit: { n:37, topic:'Chemistry: Combustion, Burning &amp; Fire Safety', status:'ASMOPSS 2026 is over (Prem scored 58.75/97.5, 60.3%) &mdash; coaching continues into regular school Science and ASMOPSS 2027 prep. Unit 37 is the FIRST unit of the new post-ASMOPSS rotation, weighted toward Physical Science per the retrospective analysis (Physical Science was the weakest strand at 52%, carrying 69.2% of the real exam&#39;s marks). Two lessons built: `Combustion_Lesson_FireTriangleAndOxygen.html` (the fire triangle: fuel + oxygen + heat, and why oxygen &mdash; not the far more common nitrogen &mdash; is what actually supports burning, directly closing the real exam&#39;s Q30 gap) and `Combustion_Lesson_FireSafetyAndTrapRecognition.html` (firefighting methods matched to the triangle, plus Trap-Recognition Drill #1 &mdash; spotting absolute/overgeneralized language like &quot;always/never/only/all&quot;, the real exam&#39;s single highest-value miss cluster, 6.25 marks, never before drilled anywhere in the program). Test `Tests/Unit_37_Test_CombustionAndFireSafety.html` (20Q, 4A/6B/10C, PASS_BAR 16, flame theme) is the FIRST test in the program to tag every question with its ASMOPSS difficulty tier (Basic/Intermediate/Applied) alongside topic, and report tier-split results automatically &mdash; operationalizing the retrospective&#39;s tier-tracking recommendation. Built and verified: position-balanced exact 5/5/5/5, a length-margin pass fixed 14 of 20 questions, zero HTML tag-balance issues, scoring engine verified via a Node harness (perfect run 20/20; all-wrong run 0/20; section AND tier splits both compute correctly). Ready for Prem to take.' },

  lastUnit: {
    n:36, score:20, outOf:20, pct:100, delta:22, prevScore:78, passed:true,
    patternLabel: 'Unit 36 result - Scientific Investigation Skills (20/20, 100% PERFECT)',
    patternInsight: '<strong>20/20 (100%)</strong> - PERFECT, the program&#39;s FIFTH perfect score (after U8, U21, U27, U33). Section A = <strong>4/4 (100%)</strong>. Section B = <strong>6/6 (100%)</strong>. Section C = <strong>10/10 (100%)</strong>.',
    analysisLabel: 'Conductor/insulator 3-instance gap CLOSED &middot; both Mock Test 1 hard-tier failure modes confirmed closed &middot; program complete, exam tomorrow',
    analysisInsight: 'A clean sweep across all three sections, with every single targeted watch-item confirmed closed on the first attempt. Conductor/insulator identification - the CONFIRMED 3-INSTANCE RECURRING GAP (U34 -&gt; U35 -&gt; Mock Test 1, always choosing a metal object) - is now CLOSED: all three dedicated confirming reps (Q2, Q8, Q15) were answered correctly, the FOURTH confirmed instance in this program of the &quot;escalate to a concrete device after 3 misses&quot; strategy working immediately. The multi-group fair-test &quot;clue table&quot; method, directly targeting Mock Test 1&#39;s Q36 failure mode, held cleanly across all three dedicated scenarios (Q5/Q6, Q11/Q12, Q19) including the &quot;2+ things changed at once&quot; warning-sign question (Q10). Two-clue reverse-factor inference, targeting Q38&#39;s failure mode, also held on both dedicated questions (Q9, Q14). Data trend vs. anomaly reading was solid throughout. No new watch-items surfaced - a rare fully clean unit. This is the FINAL assessment of the program before ASMOPSS 2026 (9 Aug, tomorrow) - no further Unit Test or Milestone Test is recommended.',
    qSummary: '<strong>20 / 20 (100%) - PERFECT, the program&#39;s fifth perfect score.</strong> Section A 4/4, Section B 6/6, Section C 10/10. Headline: conductor/insulator (the confirmed 3-instance recurring gap) CLOSED via an escalated sort-game; both of Mock Test 1&#39;s hard-tier failure modes (multi-group fair tests, two-clue reverse-factor inference) confirmed closed on every dedicated question. No new watch-items. This is the final assessment before ASMOPSS 2026 - tomorrow.',
    qBreakdown: []
  },
