...
var PREM_DATA = {
  ...
  currentUnit: { n:35, topic:'Final Gap-Closure Checkpoint', status:'Test ready &middot; review-only capstone (NO new lessons, matching the U20/U30 precedent) - a Review page + a 20Q test (4A/6B/10C, pass bar 16/20). The FIFTH and FINAL unit before ASMOPSS 2026 (9 Aug). `Checkpoint_U35_Review.html` (gold/amber theme) opens with 8 Quick Recap Cards spanning the durable content from Units 21-30 plus U6/U34 circuits and Observation-vs-Inference, then three Priority Refreshers with embedded interactive Quick Checks: (1) a brand-new dedicated fair-test/graph-reading exam-skills refresher (a decision tree for independent/dependent/controlled variables plus a worked bar-chart &quot;calculate the difference, don&#39;t just compare heights&quot; example) - never given dedicated content before; (2) the magnet-vs-magnetic-material reverse-inference trap from U34&#39;s Q6, explained explicitly with a fresh steel-washer Quick Check; (3) longer magnet chains, with a fresh 3-magnet worked example that varies U34&#39;s pattern (given pole at the LAST magnet&#39;s far end instead of the first, REPEL-then-ATTRACT instead of ATTRACT-then-ATTRACT). Test `Tests\\Unit_35_Test_FinalGapClosureCheckpoint.html` (20Q, 4A/6B/10C, PASS_BAR 16, gold theme) targets: fresh confirming reps for U34&#39;s two now-PARTIALLY-closed watch-items using scenarios that vary the specific parameters that caused the U34 misses (a paperclip-induced-magnetism reverse-inference question, Q11; a stacked-toy-blocks magnet chain with a different given-position and attract/repel pattern, Q12; plus an exam-strategy question, Q19); a light touch on U34&#39;s isolated Q2 conductor/insulator slip (Q3); two brand-new dedicated fair-test/graph-reading questions (Q5, Q6, Q13, Q14, Q18) and one exam-strategy question (Q20); and a light resweep of durable U21-U30 content (gravity/air resistance, static induction, density/heat, speed/distance/time, seasons, combining forces, observation-vs-inference). Built and verified: position-balanced exact 5/5/5/5 (fixed a severe initial 1/4/8/7 skew), a length-margin pass fixed 11 questions over the 25% threshold, a Jaccard overlap check caught and fixed 3 near-duplicates (Q8&#39;s speed question echoing Unit 30&#39;s cyclist template - reworded to a cargo-ship scenario with different units; Q11&#39;s magnet-material question echoing the Review page&#39;s own washer/filings Quick Check - reworded to a paperclip induced-magnetism scenario; Q16&#39;s 3-force question echoing both Unit 29&#39;s sled and Milestone Test 3&#39;s wagon - reworded twice, finally landing on a hot-air-balloon/wind-gusts scenario), and a hint-leak scan found zero flags. Both SVG diagrams (bar chart, 3-magnet chain) rasterized and visually verified with no bugs found. Scoring engine verified via a Python harness mirroring the JS logic (perfect run 20/20, correct 4/6/10 split; all-wrong run 0/20).' },

  lastUnit: {
    n:34, score:17, outOf:20, pct:85, delta:-15, prevScore:100, passed:true,
    patternLabel: 'Unit 34 result - Physics: Electricity, Magnetism &amp; Forces Recap (17/20, 85% - PASS)',
    patternInsight: '<strong>17/20 (85%)</strong> - PASS. Section A (recall) = <strong>3/4 (75%)</strong>. Section B (applying, &#9733;) = <strong>5/6 (83%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>9/10 (90%)</strong>.',
    analysisLabel: 'Magnet-vs-magnetic-material PARTIALLY closed (2/3) &middot; 3-magnet chain PARTIALLY closed (2/3) &middot; isolated conductor/insulator slip',
    analysisInsight: 'Both priority watch-items landed as PARTIAL closures rather than clean confirms. The magnet-vs-magnetic-material distinction held for two of its three dedicated questions but missed specifically on the &quot;what does this tell us&quot; reverse-inference format (Q6), where the wrong answer directly contradicted the question&#39;s own stated premise - the same trap the Review page&#39;s Priority Refresher 2 now explains explicitly. The 3-magnet chain-reading method also held for two of its three dedicated questions but missed on the multi-step derivation (Q11), suggesting the one-join-at-a-time habit isn&#39;t yet fully automatic under a harder chain. A third, isolated miss (Q2, conductor/insulator) does not fit either watch-item and reads as a one-off recall slip rather than a new gap. All three findings are directly targeted by U35&#39;s Priority Refreshers and confirming-rep questions, using fresh scenarios that vary the specific parameters that caused each miss.',
    qSummary: '<strong>17 / 20 (85%) - PASS.</strong> Section A 3/4, Section B 5/6, Section C 9/10. Headline: both retake watch-items (magnet-vs-material, 3-magnet chain) are PARTIALLY closed at 2/3 each, plus one isolated conductor/insulator slip - all three get dedicated, freshly-varied confirming reps in U35, the final checkpoint before ASMOPSS.',
    qBreakdown: []
  },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'FIFTH &amp; FINAL unit before ASMOPSS', c:'torange' },
        { t:'New: fair-test/graph-reading skills', c:'tgreen' },
        { t:'Confirming reps: magnet-material + chain', c:'tblue' }
      ],
