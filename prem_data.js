...
var PREM_DATA = {
  ...
  currentUnit: { n:31, topic:'Biology: Classification &amp; Digestion', status:'Test ready &middot; two lessons (Classifying Living Things; The Journey of Food: Digestion) + a 20Q test (4A/6B/10C, pass bar 16/20). First of the final 5 units before ASMOPSS 2026 (9 Aug), built from a prediction pass across five past ASMOPSS papers (2022/2023/2024 National Selection + 2024/2025 G4 Set B) cross-referenced with Prem&#39;s known gaps. Lesson 1 opens with a Quick Fix on Milestone 3&#39;s two Biology regressions (anther-vs-ovary, germination-light bare recall) before teaching the backbone split and the five vertebrate groups. Lesson 2 covers the digestive journey and enzymes - a topic confirmed never yet taught in the program despite recurring on real ASMOPSS papers (e.g. the 2024 G4 Set B biscuit-breakdown question). Built and verified: position-balanced exact 5/5/5/5, zero length-margin violations after two rounds of targeted rewording, a Jaccard overlap check against all prior lesson+test files caught and fixed 2 real near-duplicate distractor options (echoing Unit 11&#39;s own test) and 1 flower-part question echoing Units 17/25&#39;s own lesson practice - all reworded with fresh phrasing; a div/paragraph tag-balance sweep caught and fixed one unclosed &lt;p&gt; tag in Lesson 1&#39;s Quick Fix screen. Scoring engine verified via a Node harness (perfect run 20/20, correct 4/6/10 split; all-wrong run 0/20). Zero hint-leak flags.' },

  lastUnit: {
    n:'M3', score:34, outOf:40, marks:90, marksOutOf:100, pct:90, delta:-5, prevScore:95, passed:true,
    patternLabel: 'Milestone Test 3 result - All Units (U21-U30) (34/40, 90/100 marks, 90% - PASS, lowest of the three milestones so far, still comfortable)',
    patternInsight: '<strong>34/40 questions, 90/100 marks (90%)</strong> - PASS, well above the 80/100 bar. Section A (recall) = <strong>12/16 (15/20 marks)</strong>. Section B (applying, &#9733;) = <strong>14/16 (35/40 marks)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>8/8 (40/40 marks) PERFECT - second consecutive milestone test with a perfect Section C.</strong>',
    analysisLabel: 'Anther-vs-ovary REGRESSED after being closed by Unit 30 &middot; air-resistance/gravity &amp; electrostatic induction cracked for the first time &middot; Speed/Distance formula bare-recall inversions',
    analysisInsight: 'Three confirming reps held (Q15 force-for-distance, Q30/Q34 3-force grouping, Q31 magnet-pole) and the anther-vs-stigma applied check passed (Q32). But Q10 (anther-vs-ovary bare recall) REGRESSED - the exact wrong-answer pattern first seen in Milestone Test 2, which Unit 30&#39;s Q14 had since confirmed closed. Two previously-solid facts cracked for the first time under fresh framings: Q2 (air resistance, perfect since Unit 21&#39;s 20/20) and Q19 (electrostatic induction, closed across four framings in Unit 23). Two further bare-recall-vs-application splits: Q9 (germination-light reactivated at bare recall despite a correct critique-level answer at Q36) and Q11/Q25 (Speed and Distance formulas both inverted at bare recall despite correct applied use elsewhere in the same test). General finding: previously-closed facts are proving less durable under a long, cumulative 40-question milestone paper than under recent, single-topic unit tests - this directly shaped the final-5-units plan, folding maintenance reps for these exact facts into Units 31 and 32.',
    qSummary: '<strong>34 / 40, 90/100 marks (90%) - PASS, the lowest of the three milestones so far, still comfortable.</strong> Section C went a PERFECT 8/8 for the second consecutive milestone test. Headline: the anther-vs-ovary confusion REGRESSED after being closed by Unit 30, and two previously-solid facts (air-resistance/gravity, electrostatic induction) cracked for the first time under fresh framings. Only 10 days remained to ASMOPSS 2026 at analysis time - the next-assessment choice (fresh unit vs consolidation) was flagged to Lui, who chose a prediction-driven final-5-units plan built from five past ASMOPSS papers.',
    qBreakdown: []
  },

  skills: [
    { name: 'Biology',                  c: 89, t: 85, ev:'U4 Microorganisms 15/15 PERFECT + U8 Photosynthesis 20/20 PERFECT + U11 Human Body Systems 20/20 PERFECT + U14 Cells 19/20 (95%) + U17 Ecosystems 17/20 (85%) - closed G4 Q40, the U1 Q13 gas-exchange thread, and Competition Q24/Q7/Q14/Q32 (Q31 substantially closed) + U20 Gap-Closure Checkpoint 16/20 (80%) - upgraded germination-light to a confirmed recurring gap + Milestone Test 2 36/40 (95%) - three of the four misses were Biology, all isolated single-fact recall slips + U22 Nutrition, Vitamins &amp; a Balanced Diet 15/20 (75%, FAIL) - the third program fail; a precise symptom-to-nutrient reverse-reasoning gap found + U25 Seeds, Plant Reproduction &amp; Dispersal 14/20 (70%, FAIL) - the stamen/pistil confusion CONFIRMED across two formats, the Iron/oxygen fact failed a THIRD consecutive attempt + U26&#39;s two embedded Biology re-test questions (within the Physics test): BOTH gaps CLOSED on the escalated first attempt - Iron (Q9, a delivery-truck-analogy Quick Fix, 4th framing) and stamen/pistil (Q10, a sorting-mini-game Quick Fix, 3rd framing) both answered correctly, confirming the escalation-to-a-different-teaching-device strategy worked for both of these long-running gaps + Milestone Test 3 34/40 (90%): the anther-vs-ovary confusion REGRESSED (Q10) after being closed by U30, germination-light reactivated at bare recall (Q9) despite a correct critique-level answer later in the same test, but the anther-vs-stigma applied check (Q32) held - directly targeted by U31&#39;s Quick Fix and new Classification/Digestion content' },
