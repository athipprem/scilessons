...
var PREM_DATA = {
  ...
  currentUnit: { n:32, topic:'Physics: Heat, Temperature &amp; Materials', status:'Test ready &middot; two lessons (Heat vs Temperature; Heat Transfer &amp; Materials) + a 20Q test (4A/6B/10C, pass bar 16/20). Second of the final 5 units before ASMOPSS 2026 (9 Aug). Lesson 1 opens with an ESCALATED anther/stigma/ovary Quick Fix - the verbal-mnemonic fix failed identically twice in Unit 31 (Q8, Q16), and an independent ASMOPSS 2024 G4 Set B retake (1 Aug 2026) found the same swap on a real diagram-labelling question (Q32) - moving to a genuinely different teaching device: an interactive 3-way click-to-sort mini-game (MAKES/anther, CATCHES/stigma, BECOMES/ovary+ovule), extended from Unit 26&#39;s 2-bin stamen/pistil sorter to force explicit 3-way discrimination between all three previously-confused parts at once. The rest of Lesson 1 teaches heat vs temperature (bathtub-vs-teacup analogy) and measuring temperature on the Celsius scale (0&deg;C/37&deg;C/100&deg;C reference points, SVG thermometer diagram). Lesson 2 covers the three ways heat travels (conduction/convection/radiation, SVG diagram), insulators vs conductors of heat (bridging Unit 6), and melting/freezing/boiling points including the melting-point-equals-freezing-point insight. The test carries two dedicated anther/stigma/ovary confirming reps (a bare-recall stigma question and a harder 3-part applied bee-pollination ordering question) - the third consecutive escalated attempt at this fact. Built and verified: position-balanced exact 5/5/5/5, a length-margin pass fixed 12 questions over the 25% threshold via trimming/lengthening (one numeric Celsius-value question kept as an accepted exception, since its option lengths are fixed by real reference-point values), a Jaccard overlap check caught and fixed 2 near-duplicate question stems echoing the lesson&#39;s own practice/Quick-Check wording. Both new SVG diagrams rasterized and visually verified with no bugs found. Scoring engine verified via a Node harness (perfect run 20/20, correct 4/6/10 split; all-wrong run 0/20). Zero hint-leak flags.' },

  lastUnit: {
    n:31, score:16, outOf:20, pct:80, delta:-10, prevScore:90, passed:true,
    patternLabel: 'Unit 31 result - Biology: Classification &amp; Digestion (16/20, 80% - PASS, right at the pass bar)',
    patternInsight: '<strong>16/20 (80%)</strong> - PASS, right at the pass bar. Section A (recall) = <strong>4/4 (100%)</strong>. Section B (applying, &#9733;) = <strong>5/6 (83%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>7/10 (70%)</strong>.',
    analysisLabel: 'Anther-vs-ovary Quick Fix FAILED both reps identically &middot; germination-light Quick Fix RESOLVED &middot; two new gaps (analogy-transfer, fair-test variable confusion)',
    analysisInsight: 'Both dedicated confirming reps for the anther-vs-ovary/stigma Quick Fix failed, and identically each time (Q8 chose "the ovary" instead of "the anther"; Q16 chose "the stigma, then the anther" instead of the correct "the anther, then the ovary") - the verbal-mnemonic-style fix from Milestone Test 3 did not hold under this unit&#39;s fresh classification/digestion content, directly motivating an ESCALATION to a genuinely different teaching device (an interactive 3-way JOB-sort mini-game) in Unit 32. The germination-light Quick Fix, by contrast, fully RESOLVED (Q4 bare recall and Q17 applied scenario both correct) - the second Biology gap in the program to close via a dedicated Quick Fix screen. Two new misses surfaced in the fresh classification/digestion content: Q15, an analogy-transfer gap bridging root hairs to small-intestine villi (both absorb via a similar increased-surface-area mechanism, but the transfer did not happen automatically), and Q19, a fair-test "what was kept the same" variable-confusion question. An independent retake of the ASMOPSS 2024 G4 Set B competition paper (1 Aug 2026, +18.75 marks over the original sitting) further reinforced the anther-vs-ovary finding: Q32, a real-exam flower-diagram labelling question, was missed identically both times a month apart with the same anther/stigma position swap - independent evidence supporting the U32 escalation decision from a completely different question format.',
    qSummary: '<strong>16 / 20 (80%) - PASS, right at the pass bar.</strong> Section A held perfect at 4/4. Headline: the anther-vs-ovary Quick Fix failed BOTH dedicated confirming reps identically, while the germination-light Quick Fix fully resolved. Two new gaps surfaced in the fresh classification/digestion content (analogy-transfer, fair-test variable confusion). Escalated to a 3-way JOB-sort mini-game as the anther/stigma/ovary fix in Unit 32.',
    qBreakdown: []
  },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'Second of the final 5 units', c:'torange' },
        { t:'3-bin JOB-sort escalation', c:'tgreen' },
        { t:'Competition-confirmed target', c:'tblue' }
      ],
