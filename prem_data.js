...
var PREM_DATA = {
  ...
  currentUnit: { n:22, topic:'Biology: Nutrition, Vitamins &amp; a Balanced Diet', status:'Lessons + test ready &middot; second unit of the U21-U30 gap-closure cycle. Lesson 1 recalls U11&#39;s digestive system and introduces the six nutrient groups (carbohydrates, protein, fats, vitamins &amp; minerals, fibre, water) plus the balanced-plate model. Lesson 2 covers key vitamins and minerals by name (Vitamin A, C, D, calcium, iron) and tells the real story of scurvy and James Lind&#39;s 1747 fair-test experiment aboard HMS Salisbury, directly closing the gap found on Competition C2 (Q18, a Vitamin C fact). Test: 20 questions, 4A/6B/10C, PASS_BAR 16, verified position-balanced 5/5/5/5, margin-clean, and zero real overlap against the full lesson/test corpus.' },

  lastUnit: {
    n:21, score:20, outOf:20, pct:100, delta:5, prevScore:95, passed:true,
    patternLabel: 'Unit 21 result - Physics: Falling Objects, Gravity &amp; Air Resistance (20/20, 100% - PASS, PERFECT SCORE)',
    patternInsight: '<strong>20/20 questions (100%)</strong> - PASS, a perfect score. Section A (basic recall) = <strong>4/4 (100%)</strong>. Section B (applying, &#9733;) = <strong>6/6 (100%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>10/10 (100%)</strong>.',
    analysisLabel: 'CONFIRMS Competition C2&#39;s Q16-vs-Q22 gravity gap closed on the first attempt &middot; observation-vs-inference gets a third correct rep in a row, now fully closed',
    analysisInsight: 'The headline finding: every single question, across all three sections, was answered correctly on the very first attempt. This directly confirms Competition C2&#39;s Q16-vs-Q22 gravity gap is closed - Prem already understood that denser objects fall faster IN AIR (air resistance), and now also correctly applies the no-air/vacuum equal-fall-rate rule (all objects fall at the same rate with nothing pushing back), tested via both a standalone vacuum framing and an in-air comparison framing. A bonus finding: Q17, an embedded observation-vs-inference question (a leaf drifting down), was also answered correctly - the third clean rep in a row for that skill since U18&#39;s refresher (U18 &check;, Milestone Test 2 Q32 &check;, U21 Q17 &check;), upgrading it from "watch for recurrence" to fully closed. No misses anywhere means no new gaps surfaced this unit.',
    qSummary: '<strong>20 / 20 (100%) - PASS, PERFECT SCORE.</strong> Every section clean. CONFIRMS the Competition C2 gravity gap (Q16 vs Q22) closed on the first attempt, plus a third clean observation-vs-inference rep (now fully closed). No misses.',
    qBreakdown: []
  },
  ...
  skills: [
    ...
    { name: 'Scientific Investigation', c: 93, t: 85, ev:'Section C 80% (U1), 100% (U2-U8), 90% (U9), 100% (U10), 100% (Milestone 1, 8/8), 100% (U11-U12), 60% (U13), 100% (U14), 90% (U15), 80% (U16-U20) + Milestone Test 2: Section C 8/8 (100%) - a PERFECT run, matching Milestone 1&#39;s own 8/8 record + U21: Section C 10/10 (100%) PERFECT, including a fresh fair-test-design question (paper-shape scenario) and a claim-correction question, both answered correctly - applied reasoning under the ANSWER-BALANCE RULE remains a confirmed strength' },
    { name: 'Applied Reasoning',        c: 92, t: 85, ev:'U1 80%, U2-U8 100%, U9 90%, U10 100%, Milestone 1 100% (8/8), U11-U12 100%, U13 60%, U14 100%, U15 90%, U16-U20 80% + Milestone Test 2: Section B 16/16 AND Section C 8/8 - all 32 applied/reasoning-heavy questions correct + U21: Section B 6/6 AND Section C 10/10 - all 16 applied/reasoning-heavy questions correct on a fresh Physics topic, plus a third consecutive correct observation-vs-inference rep (now fully closed)' }
  ],
  radarCurrent:  [92, 93, 93, 90, 93, 92],
