...
var PREM_DATA = {
  ...
  currentUnit: { n:41, topic:'Chemistry: Acids, Bases &amp; Chemical vs Physical Change', status:'&#9989; Ready to start &mdash; built 18 Aug 2026. First unit of a fresh 10-unit rotation block (U41-U50), opened after Milestone Test 4 closed U31-U40. Brand-new topic never given dedicated coverage before: acid/base testing via litmus paper, and the deeper evidence-based signs of chemical vs physical change, capped by a worked vinegar + baking soda reaction bridging both lessons. Lesson 1 opens with a REDESIGNED escalation device (a click-based &quot;Find the Flaw&quot; mini-game, genuinely different from two prior failed MCQ attempts) targeting the sieve/filter/evaporate critique-format gap, now a confirmed 2-instance pattern (U40 Q18, Milestone 4 Q34), plus a Biology U31 spiral-maintenance warm-up per the newly-formalized rotation plan. Test: 20 questions, tier-tagged throughout, Section C sourced as genuine cross-topic synthesis from U2/U9/U36/U37/U40 rather than harder versions of the just-taught lesson, per the standing Science protocol.' },

  lastUnit: {
    n:'M4', score:36, outOf:40, marks:91.25, marksOutOf:100, pct:91, delta:1.3, prevScore:90, passed:true,
    patternLabel: 'Milestone Test 4 result - All Units, U31-U40 (36/40, 91.25/100, 91% PASS)',
    patternInsight: '<strong>36/40, 91.25/100 marks (91%)</strong> - PASS, beating Milestone 3&#39;s baseline of 90/100 by 1.3 marks. Section A = <strong>13/16</strong>. Section B = <strong>16/16 (100%)</strong>. Section C = <strong>7/8 (88%)</strong>. Tier breakdown identical to section breakdown: Basic 13/16, Intermediate 16/16, Applied 7/8.',
    analysisLabel: 'Every confirming rep held except the sieve/filter critique &middot; new U36 bare-vocabulary decay found &middot; sieve/filter/evaporate gap now a confirmed 2-instance pattern, escalated in Unit 41',
    analysisInsight: 'Four misses: Q4, Q9, Q10, Q34. <strong>Strong result overall:</strong> the anther/stigma confirming rep (Q17), the 3-object air-resistance ranking rep (Q30), and two of the three sieve/filter/evaporate touches (Q31, Q33) all held correct, and Section B ran a perfect 16/16. <strong>New finding:</strong> Q9 and Q10, both bare-definitional-recall questions on Unit 36&#39;s control-group and anomaly vocabulary, were missed - even though Unit 36&#39;s OTHER signature skills (conductor/insulator on Q8, two-clue reverse-factor on Q25) held correct, isolating this to bare terminology decay specifically rather than a broader Unit 36 regression. <strong>Isolated slip:</strong> Q4 (Unit 32 heat-transfer-by-radiation-across-a-vacuum) was missed on its own, with no other Unit 32 items nearby to corroborate a pattern. <strong>Headline finding:</strong> Q34, the fourth and most demanding sieve/filter/evaporate touch (a multi-step critique of a flawed separating plan), was missed - the SAME critique-format failure shape as Unit 40&#39;s Q18, now a confirmed 2-instance pattern across two real tests. This directly shaped Unit 41&#39;s design: a brand-new, click-based &quot;Find the Flaw&quot; escalation device replaces the MCQ format entirely.',
    qSummary: '<strong>36 / 40, 91.25/100 marks (91%) - PASS.</strong> Section A 13/16, Section B 16/16 (perfect), Section C 7/8. Beat Milestone 3&#39;s 90/100 baseline. Headline: every confirming rep held except the sieve/filter/evaporate critique-format gap, now escalated in Unit 41 with a genuinely new teaching device. Confirmed next assessment: Unit 41 (Chemistry: Acids, Bases &amp; Chemical vs Physical Change), the first unit of a fresh U41-U50 rotation block.',
    qBreakdown: []
  },
  ...
  radarCurrent:  [89, 91, 94, 91, 95, 95],
