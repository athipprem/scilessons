...
var PREM_DATA = {
  ...
  currentUnit: { n:38, topic:'Biology: Plant Reproduction Outcomes &mdash; Fruit vs Seed', status:'BUILT 13 Aug 2026 &mdash; ready to take. Second unit of the post-ASMOPSS rotation (&sect;50), closing the real 2026 exam&#39;s Q25 gap: ovary wall &rarr; fruit, ovule &rarr; seed. Opens with 2 quick confirming checks from Unit 37 (oil-fire immediate-action on a fresh campsite scene, trap-recognition strategy generalized beyond fire) per the &sect;51 recommendation. Embeds the program&#39;s FIRST Spaced-Retention Checkpoint &mdash; re-testing anther/ovary/stigma roles (closed U25/U32) and duckweed-root function (closed U33), both a month or more old, with fresh scenes rather than the original framings. Also the first test built under the new same-fact-pair design rule (create-new-test-pack skill G.7, added 13 Aug after U37&#39;s Q5/Q15 finding) &mdash; every question verified via position balance (5/5/5/5), length margin, within-test Jaccard uniqueness (zero flags), and a scoring-engine harness.' },

  lastUnit: {
    n:37, score:17, outOf:20, pct:85, delta:-15, prevScore:100, passed:true,
    patternLabel: 'Unit 37 result - Combustion & Fire Safety (17/20, 85% PASS)',
    patternInsight: '<strong>17/20 (85%)</strong> - PASS, first unit of the post-ASMOPSS rotation. Section A = <strong>4/4 (100%)</strong>. Section B = <strong>5/6 (83%)</strong>. Section C = <strong>8/10 (80%)</strong>. First tier breakdown in the program: Basic 4/4, Intermediate 5/6, Applied 8/10.',
    analysisLabel: 'Q5/Q15 near-duplicate found + fixed (new standing rule) &middot; oil-fire immediate-action gap &middot; trap-recognition landed 4/5 on first outing',
    analysisInsight: 'Three misses: Q5, Q15, Q20. <strong>Process finding:</strong> Q5 and the original Q15 were near-duplicate questions (both an oil-pan-fire &quot;what do you do&quot; scenario) - a real build error caught by Lui, fixed same day (Q15 rewritten into a genuine synthesis question), and turned into a new standing same-test uniqueness rule. Because they were near-duplicates, the two misses are read as ONE content gap, not two. <strong>Content finding 1:</strong> the &quot;never use water on an oil fire&quot; rule holds in explain-why framing (Q6, Q17 both correct) but not yet in immediate-action framing (Q5/Q15 both missed, picking water both times) - a bare-recall-vs-applied-decision split matching a recurring pattern-type from earlier in the program. <strong>Content finding 2:</strong> Trap-Recognition Drill #1 (never taught anywhere in the program before this unit, per the post-ASMOPSS retrospective) landed strongly on its first outing - 4 of 5 dedicated questions correct (Q11, Q12, Q14, Q17), with only the most abstract &quot;what&#39;s your strategy&quot; framing (Q20) missed. Both findings are light, first-pass gaps - recommended fix is two short confirming reps folded into U38, not a dedicated remediation unit.',
    qSummary: '<strong>17 / 20 (85%) - PASS.</strong> Section A 4/4, Section B 5/6, Section C 8/10. Headline: a near-duplicate question pair (Q5/Q15) was found and fixed post-submission (now a standing verification rule); the oil-fire water exception holds in explain-why framing but not yet immediate-action framing; Trap-Recognition Drill #1 landed 4/5 on its first outing. Confirmed next assessment: Unit Test (U38).',
    qBreakdown: []
  },
