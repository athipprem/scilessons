...
var PREM_DATA = {
  ...
  currentUnit: { n:'MockTest1', topic:'Mock Test 1 &mdash; Full Syllabus Practice', status:'Test ready &middot; the FIRST of 2 planned ASMOPSS-style mock tests, built 7 Aug 2026 with 2 days left to ASMOPSS 2026 (9 Aug). NOT a real past paper &mdash; an original test written by Luikishi in the exact G4 Set B format (40 questions, 16A/16B/8C, 1.25/2.5/5 mark weighting = 100 marks total, pass bar 80), covering the FULL syllabus (U1-U35). Weighted toward the themes that recur every year across all 5 real ASMOPSS papers analysed (classification, fair-test/experiment design, light, magnetism, photosynthesis, forces, astronomy, graph/data reading) plus the program&#39;s current open watch-items: three dedicated magnet-vs-magnetic-material questions at rising difficulty (Q6 direct, Q23 induced-magnetism, Q34 hard reverse-inference &mdash; the exact format that broke twice on U34/U35), one conductor/insulator recall question (Q10) and one electrical-safety critique (Q40) targeting the confirmed 2-instance recurring gap, and dedicated independent/dependent/controlled-variable questions (Q3, Q20) targeting U35&#39;s new vocabulary mix-up. Built and verified: position-balanced exact 10/10/10/10 across all 40 questions, zero length-margin violations after fixing 27 initially-flagged questions, a Jaccard overlap check caught and fixed 4 near-duplicates against the corpus (Q15 water-cycle phrasing, Q5 magnet-repel phrasing, Q16 speed-calculation vocabulary, Q22 magnet-chain scenario echoing the U34 lesson&#39;s own worked example), and zero hint-leak flags. No diagrams used &mdash; all spatial content (magnet chains, Moon phases) described in clear text instead, to keep build time tight with 2 days left. Scoring engine verified via a Python harness (perfect run 40/40 = 100 marks; all-wrong run 0/40 = 0 marks; Part A/B/C weighting sums to exactly 100). Full 10-year-old role-play verification pass completed end-to-end.' },

  lastUnit: {
    n:35, score:17, outOf:20, pct:85, delta:0, prevScore:85, passed:true,
    patternLabel: 'Unit 35 result - Final Gap-Closure Checkpoint (17/20, 85% - PASS)',
    patternInsight: '<strong>17/20 (85%)</strong> - PASS. Section A (recall) = <strong>2/4 (50%)</strong>. Section B (applying, &#9733;) = <strong>5/6 (83%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>10/10 (100%) PERFECT</strong>.',
    analysisLabel: '3-magnet chain CONFIRMED CLOSED &middot; magnet-vs-material STILL PARTIALLY closed (reverse-inference format) &middot; new variable-vocabulary slip &middot; conductor/insulator now a confirmed 2-instance gap',
    analysisInsight: 'Section C went a PERFECT 10/10, and the 3-magnet chain multi-step derivation is now CONFIRMED CLOSED on its first confirming rep (Q12, Q19) after U34&#39;s miss. But the magnet-vs-magnetic-material distinction is only PARTIALLY closed and more concerning than U34 alone suggested: the deeper induced-magnetism scenario (Q11) held, but Q7 - built as a light recap, structurally almost identical to U34&#39;s original failing question - was missed AGAIN, isolating the fragile point specifically to the &quot;what does this tell us&quot; reverse-inference sentence format itself, not the underlying concept. Two Section A misses: Q2, a new dependent-vs-controlled variable mix-up on first exposure to brand-new fair-test vocabulary (though every Section C question APPLYING the same distinction was answered correctly); and Q3, a SECOND instance of the conductor/insulator slip first seen in U34 - now a confirmed recurring gap warranting a dedicated drill. This completes all five units of the prediction-driven final-5-unit plan (U31-U35). Mock Test 1, an original ASMOPSS-style full-syllabus practice paper, directly targets all three open items above.',
    qSummary: '<strong>17 / 20 (85%) - PASS.</strong> Section A 2/4, Section B 5/6, Section C 10/10 PERFECT. Headline: 3-magnet chain CONFIRMED CLOSED; magnet-vs-material still PARTIALLY closed (missed the reverse-inference format a second time); a new variable-vocabulary slip and a now-confirmed 2-instance conductor/insulator gap. All five units of the final-5-unit plan complete - Mock Test 1 is next.',
    qBreakdown: []
  },
