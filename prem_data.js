...
var PREM_DATA = {
  ...
  currentUnit: { n:28, topic:'Earth &amp; Space: Earth&#39;s Tilt &amp; the Seasons', status:'Lessons + test ready &middot; eighth unit of the U21-U30 gap-closure cycle, extending Unit 7&#39;s astronomy content and directly targeting Competition C2&#39;s Q25 gap (hemisphere-reversed seasons). Lesson 1 `Seasons_Lesson_EarthsTiltAndSeasons.html` (green, 7 screens: pocket map, Quick Recall of Unit 7&#39;s rotation/revolution facts, why, THE TILT screen with an SVG diagram showing Earth at its June and December orbit positions and how the fixed 23.5&deg; tilt points the same hemisphere toward or away from the Sun at different times of year, a MYTH VS MECHANISM screen busting the &quot;seasons are caused by distance&quot; myth with an SVG comparing direct vs slanted sunlight rays plus the real fact that Earth is closest to the Sun in January and farthest in July, decision tree, 5Q practice). Lesson 2 `Seasons_Lesson_HemisphereReversal.html` (blue, 7 screens: pocket map, Quick Recall from Lesson 1, why (a Scientist&#39;s Tool screen on transferring a rule to a new, unshown case), THE REVERSAL screen with a full 4-way hemisphere season-pairing table (Summer&harr;Winter, Autumn&harr;Spring), real-life applications (Christmas in Australia = summer, reversed school-holiday months, the equator exception), decision tree, 5Q practice). Test `Tests\\Unit_28_Test_EarthsTiltAndTheSeasons.html` (20Q, 4A/6B/10C, PASS_BAR 16) covers tilt basics, applying tilt direction to hemisphere seasons, the distance myth-bust, and applied scientific-reasoning questions (critiquing claims, transferring the direct-vs-slanted-rays logic to a new context, the equator exception, day-length reasoning). Position distribution exact 5/5/5/5. An initial length-margin pass found 9 questions over a 25% margin (up to 114% on one) - rebalanced across two rounds of edits down to a max 24.1% margin, none over. A Jaccard overlap check against both new lessons caught two near-duplicate questions (echoing Lesson 2&#39;s own practice wording) - both reworded with fresh scenario framings while preserving what was tested; a stricter cross-unit check against Unit 7&#39;s own lesson files found zero overlaps. One SVG diagram text-overlap bug (December-position labels colliding with the Earth graphic) was found via rasterization and fixed. Scoring engine verified via a Node harness (20 valid questions, correct 4/6/10 section split, perfect run scores 20/20, all-wrong run scores 0/20).' },

  lastUnit: {
    n:27, score:20, outOf:20, pct:100, delta:5, prevScore:95, passed:true,
    patternLabel: 'Unit 27 result - Earth &amp; Space: Models of the Solar System (20/20, 100% - PASS, PERFECT SCORE, the program&#39;s third)',
    patternInsight: '<strong>20/20 questions (100%)</strong> - PASS, a PERFECT score, comfortably above the 16/20 bar. Section A (basic recall) = <strong>4/4 (100%)</strong>. Section B (applying, &#9733;) = <strong>6/6 (100%)</strong>. Section C (think like a scientist, &#9733;&#9733;) = <strong>10/10 (100%, perfect)</strong>.',
    analysisLabel: 'Competition C2&#39;s Q23 gap (heliocentric vs geocentric, Venus&#39;s phases) CONFIRMED CLOSED &middot; zero misses across all three sections &middot; the program&#39;s third PERFECT score (after U8, U21)',
    analysisInsight: 'Headline finding: a completely clean sweep on a topic with no prior direct exposure beyond Unit 7&#39;s basic Sun-centred-layout fact. Every question across geocentric-vs-heliocentric model recall, Copernicus and Galileo&#39;s historical roles, Venus&#39;s phases as observational evidence, and applied scientific-reasoning critique-style questions was answered correctly. This directly CONFIRMS Competition C2&#39;s Q23 gap is CLOSED on the first attempt - the model-testing logic (choosing between two equally-fitting ideas via a new, different prediction) transferred cleanly to a brand-new topic, extending the established pattern of Section B/C strength seen across U21 and U26. No misses means no new gaps surfaced this unit.',
    qSummary: '<strong>20 / 20 (100%) - PASS, a PERFECT SCORE, the program&#39;s third (after Unit 8 and Unit 21).</strong> Headline: Competition C2&#39;s Q23 gap (heliocentric vs geocentric models, Venus&#39;s phases as evidence) is CONFIRMED CLOSED - zero misses across all three sections on a topic taught for the first time this unit, beyond Unit 7&#39;s basic Sun-centred-layout fact. Section B and Section C both went a perfect 6/6 and 10/10.',
    qBreakdown: []
  },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'Eighth unit of the U21-U30 cycle', c:'torange' },
        { t:'Targets C2 Q25 (hemisphere seasons)', c:'tblue' },
