...
var PREM_DATA = {
  ...
  currentUnit: { n:21, topic:'Physics: Falling Objects, Gravity &amp; Air Resistance', status:'Lessons + test ready &middot; first unit of the U21-U30 gap-closure cycle, combining Milestone 2 and Competition C2 findings. Lesson 1 recalls U10&#39;s mass-vs-weight distinction, then teaches the surprising fact that gravity pulls every object at the same rate regardless of mass (a Galileo-style diagram). Lesson 2 teaches air resistance as a friction-like force affected by shape/surface area, then ties both halves together with the real Apollo 15 hammer-and-feather Moon experiment. Directly closes the gap found on Competition C2 (Q16 vs Q22): Prem understood the with-air-resistance rule but not the no-air/vacuum equal-fall-rate rule. Test: 20 questions, 4A/6B/10C, PASS_BAR 16, verified position-balanced 5/5/5/5 and margin-clean, zero overlap with all 63+ prior lesson/test files.' },

  lastUnit: {
    n:'M2', score:36, outOf:40, marks:95, marksOutOf:100, pct:95, delta:0, prevScore:98.75, passed:true,
    patternLabel: 'Milestone Test 2 result - All Units (U11-U20) (36/40, 95/100 marks, 95% - PASS, second-best milestone result of the program)',
    patternInsight: '<strong>36/40 questions (95%)</strong> - PASS, second only to Milestone 1&#39;s 98.75/100 personal best. Section A (basic recall, 1.25 marks each) = <strong>12/16 (75%)</strong> - four misses. Section B (applying, 2.5 marks each) = <strong>16/16 (100%)</strong> - perfect. Section C (think like a scientist, 5 marks each) = <strong>8/8 (100%)</strong> - perfect.',
    analysisLabel: 'Every Section B and Section C question correct (32/32) &middot; both of U20&#39;s open items confirmed via dedicated re-test questions &middot; a distinct, narrower germination sub-error surfaced instead',
    analysisInsight: 'The headline finding: all 32 Section B and Section C questions - the sections carrying almost all real ASMOPSS marks and rewarding applied reasoning - were answered correctly. All four misses fell in the lowest-value Section A recall section (5 marks lost out of 100). Both of U20&#39;s open watch-items were directly re-tested and both came back correct: Q24 (sunny-vs-dark germination jars, both germinate equally) confirms the "seeds need light" belief may be resolving, and Q32 (apple/claw-marks observation-vs-inference) confirms that skill held. But a distinct germination sub-error appeared instead: Q9 (Section A recall - what else, besides water and air, must a seed have) - Prem chose Soil instead of Warmth, a different, narrower confusion than the light misconception. The other three misses (Q3 natural-vs-man-made light source, Q4 cell-wall-vs-membrane, Q10 anther-vs-ovary) are isolated single-fact recall slips across three unrelated topics with no shared mechanism. All previously-tracked gaps (point-vs-broad light source, PE/KE swap, tide frequency, fast-read density inversion) held correctly under fresh Section B/C scenarios.',
    qSummary: '<strong>36 / 40 (95%) - PASS</strong>, second-best milestone result of the program. Every Section B and Section C question correct (32/32). Both of U20&#39;s open items (germination-light, observation-vs-inference) confirmed via dedicated re-test questions. A new, narrower germination sub-error (soil vs warmth) surfaced in Section A.',
    qBreakdown: [
      { q:'Q3', topic:'Natural vs man-made light source (Section A recall) - isolated slip', lvl:'a', pass:false, note:'Asked which is a natural source of light, not made by humans. Correct answer is the Sun; Prem chose a lightbulb instead - a natural-vs-man-made classification slip, distinct from the point-vs-broad-source shadow rule (confirmed closed, no shadow-style miss anywhere on this paper).' },
      { q:'Q4', topic:'Plant vs animal cell structures (Section A recall) - isolated slip', lvl:'a', pass:false, note:'Asked which extra structure plant cells have that animal cells lack entirely. Correct answer is the cell wall; Prem chose the cell membrane (a structure both cell types actually have) - Cells&#39; first miss since U14&#39;s 19/20.' },
      { q:'Q9', topic:'Germination requirements (Section A recall) - a new, narrower sub-error', lvl:'a', pass:false, note:'Asked what else (besides water and air) a seed needs to germinate. Correct answer is Warmth; Prem chose Soil. NOT the light misconception (sunlight was not picked) - a different confusion about the actual germination requirement list, while the applied sunny-vs-dark-jar question (Q24) was answered correctly.' },
      { q:'Q10', topic:'Flower part labelling - anther vs ovary (Section A recall) - isolated slip', lvl:'a', pass:false, note:'A bee brushes against fine yellow powder on a flower. Correct answer is the anther; Prem chose the ovary - despite U17 flower-part questions on this same content having been confirmed closed.' }
    ]
  },

  skills: [
    { name: 'Biology',                  c: 92, t: 85, ev:'U4 Microorganisms 15/15 PERFECT + U8 Photosynthesis 20/20 PERFECT + U11 Human Body Systems 20/20 PERFECT + U14 Cells 19/20 (95%) + U17 Ecosystems 17/20 (85%) - closed G4 Q40, the U1 Q13 gas-exchange thread, and Competition Q24/Q7/Q14/Q32 (Q31 substantially closed) + U20 Gap-Closure Checkpoint 16/20 (80%) - upgraded germination-light to a confirmed recurring gap + Milestone Test 2 36/40 (95%) - three of the four misses were Biology (Q4 cell-wall-vs-membrane, Q9 germination soil-vs-warmth, Q10 anther-vs-ovary), all isolated single-fact recall slips with no shared mechanism, while both dedicated germination/observation-inference re-test questions (Q24, Q32) were answered correctly' },
    ...
    { name: 'Scientific Investigation', c: 92, t: 85, ev:'Section C 80% (U1), 100% (U2-U8), 90% (U9), 100% (U10), 100% (Milestone 1, 8/8), 100% (U11-U12), 60% (U13), 100% (U14), 90% (U15), 80% (U16-U20) + Milestone Test 2: Section C 8/8 (100%) - a PERFECT run, the strongest applied-reasoning result of the whole program, matching Milestone 1&#39;s own 8/8 record and confirming the U18/U19/U20 dip was situational, not a skill decline' },
    { name: 'Applied Reasoning',        c: 91, t: 85, ev:'U1 80%, U2-U8 100%, U9 90%, U10 100%, Milestone 1 100% (8/8), U11-U12 100%, U13 60%, U14 100%, U15 90%, U16-U20 80% + Milestone Test 2: Section B 16/16 AND Section C 8/8 - all 32 applied/reasoning-heavy questions correct, the best applied-reasoning showing of the program to date, directly answering the earlier caveat about whether the U8-U10 streak reflected genuine mastery' }
  ],
  radarCurrent:  [92, 93, 92, 90, 92, 91],
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'Ready &#128221;', c:'tpurple' },
        { t:'First unit of the U21-U30 cycle', c:'torange' },
        { t:'Targets Competition C2 Q16/Q22 gap', c:'tblue' },
        { t:'2 lessons + 20Q test', c:'tgreen' }
      ],
      note: 'First unit of a fresh 10-unit rotation, combining Milestone 2 and Competition C2 findings into a single gap-closure plan (U21-U30). Lesson 1 `Gravity_Lesson_WhatIsGravity.html` (green, 7 screens: pocket map, Quick Recall of U10&#39;s mass-vs-weight distinction, why, what gravity does, the surprising same-fall-rate-for-every-mass fact with a strobe-style SVG diagram and a Galileo anecdote, decision tree, 5Q practice). Lesson 2 `Gravity_Lesson_AirResistanceAndFreeFall.html` (blue, 8 screens: pocket map, Quick Recall from Lesson 1, why, what air resistance is [a friction-like force], shape/surface-area SVG diagram, the real 1971 Apollo 15 hammer-and-feather Moon experiment as an SVG reveal tying both lessons together, decision tree, 5Q practice). Test `Tests\\Unit_21_Test_FallingObjectsGravityAirResistance.html` (20Q, 4A/6B/10C, PASS_BAR 16) directly targets Competition C2&#39;s Q16-vs-Q22 finding: Prem understood that denser objects fall faster IN AIR (air resistance), but not that ALL objects fall at the SAME rate with no air (vacuum) - both a standalone vacuum-only framing and an in-air comparison framing are tested, per the established comparison-vs-standalone verification pattern. **Verification found and fixed a real, substantial issue:** the first draft had the correct answer as the strict-longest option with a &ge;4-word margin on 19 of 20 questions (a major ANSWER-BALANCE RULE violation) - fixed by rewriting nearly every option set to balance lengths; final margin check is 0/20 flagged. Position distribution is an exact 5/5/5/5 A/B/C/D spread. A Jaccard overlap check first caught 3 real near-duplicates - Q2 (air resistance definition) shared an identical correct-answer phrase with Lesson 2&#39;s own practice Q1, Q3 (mass/weight-on-Moon) closely mirrored Unit 10 Lesson 2&#39;s practice Q4 template (a book/ball taken to the Moon), and Q13 (a "heavier always falls faster" claim-correction) mirrored Lesson 1&#39;s own practice Q5 almost exactly - all three rewritten with fresh framings/scenarios; a full sweep against all 63+ other lesson/test files on disk then returned zero remaining flags. Scoring engine verified via a Node harness (ALL CORRECT = 20/20 with correct 4/6/10 section split, ALL WRONG = 0/20).',
      status: 'pending'
    },
    {
