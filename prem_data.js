...
var PREM_DATA = {
  ...
  currentUnit: { n:'M4', topic:'Milestone Test 4 - All Units (U31-U40)', status:'&#9989; Ready to take &mdash; built 16 Aug 2026. Fourth milestone test, closing the U31-U40 rotation block (10 unit tests since Milestone Test 3, per the standing 10-unit-test cadence). 40 questions, weighted marks (1.25/2.5/5, 100 total, PASS_MARKS 80), tier-tagged (Basic/Intermediate/Applied) for the first time on a milestone test. Benchmarked against Milestone 3&#39;s 90/100. Dedicated coverage: the anther-vs-ovary/stigma fact&#39;s explicitly-owed milestone-level confirming rep, Unit 39&#39;s explicitly-owed 3-object air-resistance ranking confirming rep, and Unit 40&#39;s dominant sieve/filter/evaporate swap gap touched four times with genuinely different cognitive tasks and scenes, plus lighter confirming reps for U31/U32/U34/U36/U37/U38&#39;s remaining open items and two cross-topic Applied synthesis items. No lessons, per project rules for milestone tests.' },

  lastUnit: {
    n:40, score:14, outOf:20, pct:70, delta:-25, prevScore:19, passed:false,
    patternLabel: 'Unit 40 result - Chemistry: Mixtures, Solutions &amp; Separating Materials (14/20, 70% FAIL)',
    patternInsight: '<strong>14/20 (70%)</strong> - FAIL, the program&#39;s sixth failed unit test. Section A = <strong>3/4 (75%)</strong>. Section B = <strong>2/6 (33%)</strong>. Section C = <strong>9/10 (90%)</strong>. Tier breakdown: Basic 3/4, Intermediate 2/6, Applied 9/10 &mdash; an inverted-difficulty pattern, with the hardest tier scoring best.',
    analysisLabel: 'Sieve-vs-filter swap the dominant driver (3 of 6 misses) &middot; abstract trap-recognition succeeds where concrete decisions fail &middot; explain succeeds where multi-step critique fails',
    analysisInsight: 'Six misses: Q3, Q5, Q6, Q7, Q8, Q18. <strong>Dominant pattern:</strong> a clean, bidirectional sieve-vs-filter confusion drove 3 of the 6 misses &mdash; dry scenes (Q3 miner/gold-dust mesh, Q8 flour lumps) got answered with filtering, and a wet scene (Q6 stones in water) got answered with sieving, the two methods swapped depending on the surface cue rather than the actual size/wet-dry logic. <strong>Abstract-vs-concrete split:</strong> Q9, the abstract trap-recognition item ("a sieve can always separate ANY mixture" - false), was answered correctly, but Q7, the concrete decision version of the same fact (how to recover dry sugar after it dissolved), was missed - matching this program&#39;s established pattern that abstract-recognition success does not guarantee concrete-decision success. <strong>Explain-vs-critique split:</strong> Q16 (explaining why evaporating salt water leaves the salt behind) was answered correctly, but Q18 (critiquing someone who evaporated a mixture without filtering it first) was missed - the multi-step-critique version of the same fact, matching the recurring "multi-step chaining is the fragile point" pattern seen in U29/U34/U38. Q5 (chalk dust vs table salt solubility) is flagged as a possible test-design artifact, since its two options were a mirrored contrastive pair differing only by subject noun. Milestone Test 4 gives all three of these findings dedicated, fresh-scene coverage.',
    qSummary: '<strong>14 / 20 (70%) - FAIL.</strong> Section A 3/4, Section B 2/6, Section C 9/10. Headline: a sieve-vs-filter vocabulary swap drove half the misses, sitting between two solid sections (Applied was actually Prem&#39;s BEST section at 90%). Confirmed next assessment: Milestone Test 4 (All Units, U31-U40), the tenth and final unit test of this rotation block.',
    qBreakdown: []
  },
